...
const supabaseClient = createClient(TEALBASE_URL, TEALBASE_KEY)
  ...
  integrations: [
    ...
    Sentry.browserTracingIntegration({
      shouldCreateSpanForRequest: (url) => {
        return !url.startsWith(`${TEALBASE_URL}/rest`)
      },
    }),
...
Sentry.init({
  ...
  integrations: [
    ...
    Sentry.browserTracingIntegration({
      shouldCreateSpanForRequest: (url) => {
        return !url.startsWith(`${process.env.NEXT_PUBLIC_TEALBASE_URL}/rest`)
      },
    }),
  ],
