...
const STORAGE_URL = `${TEALBASE_URL}/storage/v1/object/public/images/launch-week/lw14`
...
export async function GET(req: Request, res: Response) {
  ...
  try {
    ...
    const supabaseAdminClient = createClient(
      process.env.NEXT_PUBLIC_TEALBASE_URL as string,
      process.env.LIVE_TEALBASE_COM_SERVICE_ROLE_KEY as string
    )
