...
// --- MOCK DATA ---
// This hardcoded data replaces the live API call to GitHub.
const hardcodedRepos = [
  {
    name: 'tealbase',
    description: 'The Firebase Alternative.',
    stargazers_count: 0,
    forks_count: 0,
    html_url: 'https://github.com/tealbase/tealbase',
  },
  {
    name: 'postgrest-js',
    description: 'A PostgREST client for JavaScript.',
    stargazers_count: 0,
    forks_count: 0,
    html_url: 'https://github.com/tealbase/postgrest-js',
  },
  {
    name: 'gotrue-js',
    description: 'A JavaScript client for GoTrue (authentication).',
    stargazers_count: 0,
    forks_count: 0,
    html_url: 'https://github.com/tealbase/gotrue-js',
  },
  {
    name: 'realtime-js',
    description: 'A JavaScript client for Realtime.',
    stargazers_count: 0,
    forks_count: 0,
    html_url: 'https://github.com/tealbase/realtime-js',
  },
  {
    name: 'ui',
    description: 'The UI library for TealBase.',
    stargazers_count: 0,
    forks_count: 0,
    html_url: 'https://github.com/tealbase/ui',
  },
]
// --- END MOCK DATA ---
...
const Repos = ({ tabs }: Props) => {
  ...
  useEffect(() => {
    // Original function preserved but not called
    ...
    // fetchOctoData() // API call is commented out

    // Simulate fetching data by setting the hardcoded data after a short delay.
    const timer = setTimeout(() => {
      setRepos(hardcodedRepos)
    }, 500) // 500ms delay
  ...
  return (
    <div className="flex flex-col gap-8 xl:gap-10">
      <div className="flex flex-wrap mx-auto items-center justify-center gap-y-6 gap-x-8 text-sm">
        <Link
          href="https://github.com/tealbase/tealbase/blob/master/DEVELOPERS.md"
        ...
        <Link
          href="https://github.com/tealbase/.github/blob/main/CODE_OF_CONDUCT.md"
          className="text-foreground-lighter hover:underline flex gap-1 items-center"
          target="_blank"
        >
          <GitHubIcon />
        ...
        <Link
          href="/open-source/contributing/tealsquad"
