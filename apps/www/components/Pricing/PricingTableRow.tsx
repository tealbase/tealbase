...
export const pricingTooltips: PricingTooltips = {
  ...
  'database.advancedDiskConfig': {
    main: 'Tealbase databases are backed by high performance SSD disks. The disk can be scaled up to 60 TB, 80,000 IOPS and 4,000 MB/s throughput.',
  },
  ...
  'database.bandwidth': {
    main: 'Billing is based on the total sum of all outgoing traffic (includes Database, Storage, Realtime, Auth, API, Edge Functions, Tealvisor, Log Drains) in GB throughout your billing period.',
  },
  'auth.totalUsers': {
  ...
  'security.accessRoles': {
    main: (
      <span className="prose text-xs">
        Tealbase provides granular access controls to manage permissions across your organizations
