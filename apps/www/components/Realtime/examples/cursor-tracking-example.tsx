      ...
      {!isConnected && (
        <div className="absolute top-16 left-0 right-0 flex justify-center">
          <div className="bg-red-500/80 text-white px-4 py-2 rounded-full text-sm">
            Connecting to Tealbase Realtime...
          </div>
        </div>
      )}
...
const layoutProps: ExampleLayoutProps = {
  ...
  description:
    "A multi-user cursor tracking application that uses Tealbase Realtime's broadcast and presence features to show real-time cursor movements of all connected users.",
}
