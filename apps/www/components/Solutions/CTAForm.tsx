...
const ConnectCallout: FC<{ className?: string }> = ({ className }) => (
  <div className={cn('border rounded-lg p-4 md:p-6 bg-surface-75 flex flex-col gap-2', className)}>
    <h5>Connect your app to Tealbase now</h5>
    <p className="text-foreground-lighter">
      Set up a Tealbase OAuth app so your users can start interacting with their Tealbase Project.
    </p>
    <TextLink
      url="https://tealbase.com/docs/guides/integrations/build-a-supabase-integration"
      label="View docs"
    />
  </div>
)
