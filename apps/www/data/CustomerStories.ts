...
export const data: CustomerStoryType[] = [
  {
    type: 'Customer Story',
    title: 'Euka used Tealbase to unlock faster growth',
    description:
      'Tealbase helped Euka accelerate development, simplify AI feature rollout, and scale creator marketing faster than ever.',
    organization: 'Euka',
  ...
  {
    type: 'Customer Story',
    title: "Bree's Migration to Tealbase from Fauna",
    description:
      'Discover how Bree found 10X performance gains, greater developer velocity, and a better foundation for AI when switching to Tealbase.',
    organization: 'Bree',
  ...
  },
  {
    type: 'Customer Story',
    title:
      'Quilia Empowers Personal Injury Clients with Streamlined Data Management using Tealbase',
    description:
      'Migrating to Tealbase resulted in a 75% reduction in development time, 50% lower costs, and enhanced security for sensitive client data.',
    organization: 'Quilia',
  ...
  {
    type: 'Customer Story',
    title: "Resend's Journey with Tealbase: Scaling Email Infrastructure with Ease",
    description:
      'Scaling seamlessly to 5,000+ paying customers & millions of emails sent daily with Tealbase',
    organization: 'Resend',
  ...
  {
    type: 'Customer Story',
    title: 'Scaling Innovation with Tealbase: Meshy’s Migration to Cost-Effective Authentication',
    description:
      'Discover how a rapidly growing Meshy migrated from an expensive authentication model with Auth0 to Tealbase Auth, and significantly reduced their costs.',
    organization: 'Meshy',
  ...
  },
  {
    type: 'Customer Story',
    title:
      'Scaling Beyond No-Code: asap.work’s Journey to a Faster, Flexible Solution with Tealbase',
    description:
  ...
  },
  {
    type: 'Customer Story',
    title:
      "Maergo's Express Delivery: How Tealbase Helped Achieve Scalability, Speed, and Cost Saving",
    description:
      'Discover how Maergo, a nationwide expedited parcel delivery service, reduced its codebase by 90%, decreased deployment times to just seconds, and achieved unprecedented scalability with Tealbase.',
    organization: 'Maergo',
  ...
  {
    type: 'Customer Story',
    title: 'Streamlining Success: How Tinloof Scaled Seamlessly with Tealbase',
    description:
      'Discover Tinloof, how a full-stack development agency, managed and scaled backend services using Tealbase, without having to dedicate resources to infrastructure management.',
  ...
  {
    type: 'Customer Story',
    title: 'HappyTeams unlocks better performance and reduces cost with Tealbase.',
    description:
      'How a bootstrapped startup migrated from Heroku to Tealbase in 30 minutes and never looked back.',
  ...
  {
    type: 'Customer Story',
    title: 'Tealbase migration drives shotgun to an 83% reduction in data infrastructure costs',
    description:
      "Explore how Shotgun achieved remarkable database efficiency and reduced costs by 80% through their successful migration to Tealbase's managed services.",
    imgUrl: 'images/customers/logos/shotgun.png',
  ...
  },
  {
    type: 'Customer Story',
    title:
      'Good Tape migrates to Tealbase managed Postgres and Authentication and achieves database efficiency and a 60% cost reduction',
    description:
      "Explore how Good Tape achieved remarkable database efficiency and reduced costs by 60% through their successful migration to Tealbase's managed services.",
  ...
  {
    type: 'Customer Story',
    title: 'How Next Door Lending leveraged Tealbase to become a top 10 mortgage broker',
    description: '',
  ...
  {
    type: 'Customer Story',
    title: 'Scaling securely: one million users in 7 months protected with Tealbase Auth',
    description:
      'Learn how Pebblely, an AI image generation company, used Tealbase Auth for rapid growth and adaptable security solutions.',
  ...
  {
    type: 'Customer Story',
    title: 'Bootstrapped founder builds an AI app with Tealbase and scales to $1M in 5 months.',
    description:
      'How Yasser leveraged Tealbase to build Chatbase and became one of the most successful single-founder AI products.',
  ...
  {
    type: 'Customer Story',
    title: 'Quivr launch 5,000 Vector databases on Tealbase.',
    description:
      'Learn how one of the most popular Generative AI projects uses Tealbase as their Vector Store.',
  ...
  {
    type: 'Customer Story',
    title: 'Berri AI Boosts Productivity by Migrating from AWS RDS to Tealbase with pgvector.',
    description:
      'Learn how Berri AI overcame challenges with self-hosting their vector database on AWS RDS and successfully migrated to Tealbase.',
  ...
  {
    type: 'Customer Story',
    title: 'Mendable.ai switches from Pinecone to Tealbase for PostgreSQL vector embeddings',
    description:
      'How Mendable.ai boosts efficiency and accuracy of chat powered search for documentation using Tealbase with pg_vector',
  ...
  },
  {
    type: 'Customer Story',
    title:
      'Xendit use Tealbase and create a full solution shipped to production in less than one week.',
    description:
  ...
  {
    type: 'Customer Story',
    title: 'Replenysh uses Tealbase to implement OTP in less than 24 hours.',
    description:
      'With Tealbase, Replenysh gets a slick auth experience, reduces DevOps overhead, and continues to scale with Postgres.',
