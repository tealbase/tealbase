...
export type FeatureType = {
   ...
   * - an image
   * - a youtube video
   * - a video sourced from tealbase storage
   */
  heroImage: string
  /**
...
export const features: FeatureType[] = [
  // Database
  {
    ...
    description: `
Every Tealbase project is a dedicated [Postgres database](https://www.postgresql.org/) - _"a powerful, open source object-relational database system with over 35 years of active development that has earned it a strong reputation for reliability, feature robustness, and performance"_.
...
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/database/overview',
  ...
  },
  {
    ...
    description: `
Tealbase provides an open source toolkit for developing AI applications using Postgres and pgvector. Use the Tealbase client libraries to store, index, and query your vector embeddings at scale.
...
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/ai',
  ...
  },
  {
    ...
    description: `
Tealbase automatically generates a comprehensive RESTful API from your database schema, powered by PostgREST. This feature dramatically accelerates development by eliminating the need to write boilerplate server-side code for basic CRUD operations.
...
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/api#rest-api-overview',
  ...
  },
  {
    ...
    description: `
Tealbase offers lightning-fast GraphQL APIs through its custom-built Postgres GraphQL extension, _pg_graphql_.
...
3. Real-time updates: Combine with Tealbase's real-time features for live data subscriptions.
...
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/graphql/api',
  ...
  },
  {
    ...
    description: `
Tealbase offers comprehensive database backup solutions to protect your data and ensure business continuity. These include daily backups and Point-in-Time Recovery (PITR), providing robust safeguards against various disaster scenarios.
...
5. Automated process: Backups are managed and monitored by the Tealbase team.
...
Tealbase's backup solutions provide a balance of security, flexibility, and ease of use, ensuring your data remains protected and recoverable as your project grows.
`,
    icon: DatabaseBackup,
    products: [PRODUCT_SHORTNAMES.DATABASE],
    heroImage: '/images/features/backups.png',
    heroImageLight: '/images/features/backups-light.png',
    docsUrl: 'https://tealbase.com/docs/guides/platform/backups',
  ...
  },
  {
    ...
    subtitle: 'White-label the Tealbase APIs for a branded experience.',
    description: `
Tealbase's custom domain feature allows you to use your own domain for Tealbase services, enhancing your application's branding and professionalism. Available as an add-on for paid plans, this feature offers two options: custom domains and vanity subdomains.

## Benefits:
- Branded experience for OAuth consent screens and API endpoints
- Improved portability between Tealbase projects
- Consistent domain usage across development, staging, and production

## Custom domains are particularly useful for:
- Applications using Tealbase Auth with OAuth
...
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/platform/custom-domains',
    slug: 'custom-domains',
    status: {
      stage: PRODUCT_STAGES.GA,
  ...
  },
  {
    ...
    description: `
Tealbase's Network Restrictions feature allows you to control which IP addresses or ranges can access your database, enhancing your application's security and helping you meet compliance requirements.
...
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/platform/network-restrictions',
  ...
  },
  {
    ...
    description: `
Tealbase's Postgres SSL Enforcement feature allows you to mandate SSL connections to your database, enhancing security by encrypting data in transit and protecting against potential attacks.

## Key features
1. Optional enforcement: Enable or disable SSL requirements to balance security and client compatibility.
2. Comprehensive protection: Applies to both direct Postgres and connection pooler (Tealvisor) connections.
...
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/platform/ssl-enforcement',
  ...
  {
    title: 'Branching',
    subtitle: 'Test and preview changes using Tealbase Branches.',
    description: `
Tealbase Branching allows you to create and test changes in separate, temporary environments without affecting your production setup. This feature works similarly to Git branches, enabling safe experimentation with configurations, database schemas, and new features.

## Key features
1. Git-based workflow: Integrates with GitHub, creating preview branches for each pull request.
2. Isolated environments: Each branch has its own Tealbase instance with separate API credentials.
3. Automatic migrations: Runs new migrations when changes are pushed to the ./tealbase/migrations directory.
4. Data seeding: Preview branches can be seeded with sample data using ./tealbase/seed.sql.
...
## Tealbase Branching is valuable for:
...
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/platform/branching',
    slug: 'branching',
    status: {
  ...
  },
  {
    ...
    subtitle: 'Manage Tealbase infrastructure via Terraform.',
    description: `
The Tealbase Terraform provider enables developers and DevOps teams to manage their Tealbase infrastructure as code. This integration brings the benefits of Infrastructure as Code (IaC) to your database and backend services, allowing for version-controlled, reproducible, and scalable management of Tealbase resources.
...
3. Integration with existing workflows: Seamlessly incorporate Tealbase management into your existing Terraform setups.
4. Import capability: Easily import existing Tealbase projects into your Terraform state.
...
- Scalability: Effortlessly manage multiple Tealbase projects across various teams or clients.
...
`,
  ...
  },
  {
    ...
    description: `
Tealbase Read Replicas allow you to deploy additional read-only databases that are kept in sync with your Primary database. This feature enhances performance, improves resource management, and reduces latency for global applications.
...
6. Monitoring tools: Track replication lag and resource utilization through the Tealbase Dashboard.
...
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/platform/read-replicas',
    slug: 'read-replicas',
    status: {
  ...
  },
  {
    ...
    description: `
Tealbase supports a wide array of Postgres extensions, allowing you to enhance your database with additional functionalities. These extensions enable you to tailor your database to specific needs, from geospatial data to full-text search and advanced analytics.

## Key features
1. Pre-installed extensions: Tealbase comes with over 50 pre-configured extensions.
2. Easy management: Enable or disable extensions via the dashboard or SQL commands.
3. Flexible installation: Install custom SQL extensions using Tealbase's SQL editor.
...
Popular Postgres extensions supported by Tealbase include:
...
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/database/extensions',
...
4. Easy Setup: Create webhooks directly from the Tealbase Dashboard or through SQL statements, making integration straightforward.
...
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/database/webhooks',
  ...
  },
  {
    ...
    description: `
Vault is a Postgres extension and accompanying Tealbase UI that simplifies the secure storage of encrypted secrets and other sensitive data in your database. This feature allows developers to utilize Postgres in innovative ways beyond its standard capabilities.
...
2. Easy Management: The Tealbase dashboard UI makes it simple to store and manage secrets, including environment variables and API keys.
...
`,
    ...
    heroImage: 'https://tealbase.com/docs/img/guides/database/vault-hello-compressed.mp4',
    docsUrl: 'https://tealbase.com/docs/guides/database/vault',
    slug: 'vault',
    status: {
      stage: PRODUCT_STAGES.PUBLIC_ALPHA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Tealvisor is a cloud-native connection pooler designed for Postgres, built to handle millions of connections efficiently. It was developed in Elixir and integrates advanced features such as query load balancing, named prepared statement support, and query cancellation. Tealvisor enhances the performance of Postgres by managing connections effectively, ensuring that applications can scale seamlessly under heavy loads.
...
5. Easy Integration: New Tealbase projects come with a Tealvisor connection string by default, simplifying setup for developers.
...
`,
    ...
    docsUrl: 'https://tealbase.com/blog/supavisor-postgres-connection-pooler',
    slug: 'supavisor',
    status: {
  ...
  // Realtime
  {
    ...
    description: `
Tealbase's Realtime Postgres Changes feature allows you to listen to database changes in real-time using the Realtime system. This capability enables you to build responsive, live-updating applications that reflect database changes instantly.
...
Tealbase's Realtime Postgres Changes feature provides a powerful tool for creating responsive, real-time applications while leveraging the full capabilities of your Postgres database.
`,
    icon: DatabaseZap,
    products: [PRODUCT_SHORTNAMES.REALTIME],
    heroImage: 'https://www.youtube-nocookie.com/embed/2rUjcmgZDwQ',
    docsUrl: 'https://tealbase.com/docs/guides/realtime/postgres-changes',
  ...
  },
  {
    ...
    description: `
Tealbase's Realtime Broadcast feature enables real-time communication between connected clients using the Realtime system. This functionality allows you to build interactive, collaborative applications where users can instantly share messages or data in real-time.
...
Tealbase's Realtime Broadcast feature provides a powerful tool for creating responsive, real-time applications with minimal setup and infrastructure management.
`,
    icon: MessageCircle,
    products: [PRODUCT_SHORTNAMES.REALTIME],
    heroImage: 'https://www.youtube-nocookie.com/embed/BelYEMJ2N00',
    docsUrl: 'https://tealbase.com/docs/guides/realtime/broadcast',
  ...
  },
  {
    ...
    description: `
Tealbase's Realtime Presence feature allows you to track and synchronize shared state between connected users in real-time. This capability enables you to build collaborative applications where users can see each other's status, actions, or any custom state information instantly.
...
Tealbase's Realtime Presence feature provides a powerful tool for creating interactive, real-time applications that require shared state management, allowing developers to focus on creating unique and valuable user experiences.
`,
    icon: Users,
    products: [PRODUCT_SHORTNAMES.REALTIME],
    heroImage: 'https://www.youtube-nocookie.com/embed/BelYEMJ2N00',
    docsUrl: 'https://tealbase.com/docs/guides/realtime/presence',
...
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/realtime/authorization#broadcast',
...
This feature is particularly useful for collaborative applications where knowing the online status of team members is crucial while ensuring privacy and security are maintained.`,
    ...
    products: [PRODUCT_SHORTNAMES.REALTIME, PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: 'https://www.youtube-nocookie.com/embed/IXRrU9MpA8Q',
    docsUrl: 'https://tealbase.com/docs/guides/realtime/authorization#presence',
  ...
  // Auth
  {
    ...
    description: `
Tealbase's Email Login feature enables secure email-based authentication for your applications, allowing users to create accounts and sign in using their email addresses.
...
6. SMTP integration: Use Tealbase's email service or configure a custom SMTP server.
...
- Seamless integration: Works with Tealbase's other auth providers and features.
...
Tealbase's Email Login provides a robust foundation for user authentication, allowing you to focus on building your core application features while ensuring secure account management.
`,
    icon: Mail,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/auth/passwords',
    slug: 'email-login',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Tealbase's Social Login feature enables users to authenticate using their existing accounts from popular social platforms and services, providing a streamlined, password-free access to your application.
...
Tealbase's Social Login feature allows you to improve user experience and potentially increase signup rates while maintaining security and control over user authentication.
`,
    icon: Users,
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '/images/features/social-login.png',
    heroImageLight: '/images/features/social-login-light.png',
    docsUrl: 'https://tealbase.com/docs/guides/auth/social-login',
    slug: 'social-login',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Tealbase's Phone Login feature allows users to authenticate using their phone numbers, providing a password-free login experience with SMS verification.
...
Tealbase's Phone Login feature enables a seamless authentication experience, particularly suited for mobile and SMS-centric applications, while providing an additional layer of security through phone number verification.
`,
    icon: Smartphone,
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '/images/features/phone-login.png',
    heroImageLight: '/images/features/phone-login-light.png',
    docsUrl: 'https://tealbase.com/docs/guides/auth/phone-login',
    slug: 'phone-logins',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Tealbase's Passwordless Login via Magic Links allows users to sign in by clicking a unique link sent to their email address, eliminating the need for traditional passwords.
...
Tealbase's Magic Links feature offers a secure and user-friendly authentication method, aligning with modern security practices while providing a frictionless login experience.
`,
    icon: Lock,
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '',
    docsUrl: 'https://tealbase.com/docs/guides/auth/auth-email-passwordless',
  ...
  },
  {
    ...
    description: `
Tealbase's Multi-Factor Authentication (MFA) adds an extra layer of security to your application by verifying user identity through additional steps beyond the initial login.
...
Tealbase's MFA feature provides a robust tool for enhancing application security, allowing developers to implement strong authentication measures tailored to their specific requirements.
`,
    icon: Lock,
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '',
    docsUrl: 'https://tealbase.com/docs/guides/auth/auth-mfa',
  ...
  },
  {
    ...
    description: `
Tealbase's Row Level Security (RLS) feature allows you to implement granular authorization rules directly in your Postgres database, securing your data at the row level.
...
4. Integration with Tealbase Auth: Use built-in helper functions like auth.uid() and auth.jwt() in policies.
...
Tealbase's RLS feature provides a powerful tool for implementing sophisticated access control patterns with minimal application code, enhancing security while simplifying development.
`,
    icon: Lock,
    products: [PRODUCT_SHORTNAMES.DATABASE, PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: `https://xguihxuzqibwxjnimxev.tealbase.co/storage/v1/object/public/videos/marketing/website/tealbase-rls.mp4`,
    docsUrl: 'https://tealbase.com/docs/guides/auth/row-level-security',
  ...
  },
  {
    ...
    description: `
Tealbase's Captcha Protection feature allows you to integrate CAPTCHA challenges into your authentication flows, providing an additional layer of security against automated attacks and bot activities.

## Key features
1. Multiple provider support: Integration with hCaptcha and Cloudflare Turnstile.
2. Easy configuration: Enable and configure CAPTCHA through the Tealbase Dashboard.
...
5. Token-based verification: Use CAPTCHA tokens in Tealbase auth functions for enhanced security.
...
Tealbase's Captcha Protection feature provides a powerful tool for enhancing application security, helping to protect against various automated threats while maintaining a user-friendly experience.
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/auth/auth-captcha',
  ...
  },
  {
    ...
    description: `
Tealbase's Server-side Auth feature provides tools and utilities for implementing secure user authentication in server-side environments, complementing client-side auth implementations.
...
4. @tealbase/ssr package: Simplified setup for Tealbase client in SSR environments (currently in beta).
...
Tealbase's Server-side Auth feature allows developers to create more secure and robust applications with consistent authentication across both client and server components, adhering to security best practices while leveraging Tealbase's auth system.
`,
    icon: Server,
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '',
    docsUrl: 'https://tealbase.com/docs/guides/auth/server-side',
  ...
  {
    title: 'File storage',
    subtitle: 'Tealbase Storage makes it simple to store and serve files.',
    description: `
Tealbase Storage provides a scalable solution for storing and serving files in your applications, allowing easy management of user-generated content and assets within your Tealbase project.
...
## Benefits:
- Seamless integration: Use the same Tealbase client for both database and storage operations.
...
Tealbase Storage simplifies adding robust file management to your applications, allowing you to focus on building unique features while relying on Tealbase for secure, scalable file storage and serving.
`,
    icon: Folders,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/storage',
    slug: 'file-storage',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    subtitle: 'Cache large files using the Tealbase CDN.',
    description: `
Tealbase's Content Delivery Network (CDN) feature caches and serves assets uploaded to Tealbase Storage efficiently across the globe, improving latency for users worldwide.
...
Tealbase's CDN significantly improves the performance and user experience of your applications, especially for users accessing large files or media content globally, without the complexity of managing your own CDN infrastructure.
`,
    icon: Cloud,
    products: [PRODUCT_SHORTNAMES.STORAGE],
    heroImage: '',
    docsUrl: 'https://tealbase.com/docs/guides/storage/cdn',
    slug: 'cdn',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Tealbase's Smart CDN automatically synchronizes asset metadata to the edge, ensuring content is quickly delivered and remains up-to-date without manual intervention.
...
Tealbase's Smart CDN optimizes both performance and content accuracy, providing a superior user experience for applications with dynamic or frequently updated content, without the complexity of manual cache management.
`,
    icon: Cloud,
    products: [PRODUCT_SHORTNAMES.STORAGE],
    heroImage: 'https://www.youtube-nocookie.com/embed/NpEl20iuOtg',
    docsUrl: 'https://tealbase.com/docs/guides/storage/cdn/smart-cdn',
    slug: 'smart-cdn',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Tealbase's Image Transformations feature allows you to optimize and resize images on-the-fly, directly from your storage buckets.
...
Tealbase's Image Transformations feature enables you to efficiently manage and serve optimized images, improving your application's performance and user experience while saving time and resources.
`,
    icon: Image,
    products: [PRODUCT_SHORTNAMES.STORAGE],
    heroImage: 'https://www.youtube-nocookie.com/embed/dLqSmxX3r7I',
    docsUrl: 'https://tealbase.com/docs/guides/storage/image-transformations',
  ...
  },
  {
    ...
    description: `
Tealbase's Resumable Uploads feature enables reliable transfer of large files, allowing uploads to be paused and resumed, particularly useful for files exceeding 6MB or in unstable network conditions.
...
Tealbase's Resumable Uploads feature significantly improves the reliability and user experience of file uploads, especially for large files or in scenarios with unpredictable network conditions.
`,
    icon: UploadCloud,
    products: [PRODUCT_SHORTNAMES.STORAGE],
    heroImage: 'https://www.youtube-nocookie.com/embed/pT2PcZFq_M0',
    docsUrl: 'https://tealbase.com/docs/guides/storage/uploads/resumable-uploads',
  ...
  },
  {
    ...
    description: `
Tealbase Storage offers compatibility with the S3 protocol, allowing you to use any S3 client to interact with your Storage objects.
...
## Benefits:
- Ecosystem compatibility: Leverage existing S3-compatible tools and libraries with Tealbase Storage.
...
- Easy migration: Simplify the process of moving from S3 to Tealbase or using both in parallel.
...
Tealbase's S3 compatibility allows seamless integration with existing workflows and tools, providing flexibility in data storage and management while benefiting from Tealbase's managed solution.
`,
    icon: UploadCloud,
    products: [PRODUCT_SHORTNAMES.STORAGE],
    heroImage: '/images/features/s3-compatibility.png',
    heroImageLight: '/images/features/s3-compatibility-light.png',
    docsUrl: 'https://tealbase.com/docs/guides/storage/s3/compatibility',
  ...
  // Functions
  {
    ...
    description: `
Tealbase's Deno Edge Functions allow you to deploy and run custom TypeScript functions globally at the edge, bringing your code closer to users for enhanced performance and reduced latency.
...
4. Seamless integration: Easy integration with other Tealbase services like Auth and Database.
...
- Flexibility: Extend Tealbase project capabilities beyond database operations.
...
Tealbase's Deno Edge Functions enable you to build responsive, globally distributed applications with custom server-side logic, supporting a wide range of use cases and integrations.
`,
    icon: FileCode2,
    products: [PRODUCT_SHORTNAMES.FUNCTIONS],
    heroImage: 'https://www.youtube-nocookie.com/embed/5OWH9c4u68M',
    docsUrl: 'https://tealbase.com/docs/guides/functions',
  ...
  },
  {
    ...
    description: `
Tealbase's Regional Invocations feature allows you to execute Edge Functions in a region close to your database, optimizing performance for database-intensive operations. This capability ensures low-latency communication between your functions and database, enhancing overall application responsiveness.
...
By leveraging Tealbase's Regional Invocations, you can significantly enhance the performance of your database-centric serverless functions. This feature allows you to build more responsive applications, especially those requiring frequent or complex database interactions, by ensuring that your Edge Functions operate as close as possible to your Tealbase database.
`,
    icon: Globe,
    products: [PRODUCT_SHORTNAMES.FUNCTIONS],
    heroImage: '',
    docsUrl: 'https://tealbase.com/docs/guides/functions/regional-invocation',
...
3. Code reusability: Easily port existing Node.js code to Tealbase Edge Functions.
...
- Projects migrating from Node.js-based serverless platforms to Tealbase
...
3. Scalability: Handle AI workloads efficiently with Tealbase's managed infrastructure.
4. Cost-effective AI deployment: Leverage powerful AI models without significant upfront investments.
5. Real-time AI processing: Combine AI capabilities with Tealbase's real-time features for dynamic applications.
6. Data synergy: Seamlessly use your Tealbase data with AI models for personalized experiences.
...
`,
  ...
  // Platform
  {
    ...
    description: `
Tealbase's Command Line Interface (CLI) tool provides developers with a powerful and flexible way to manage their Tealbase projects directly from the terminal. This feature streamlines the development workflow, allowing for local development, testing, and seamless deployment of Tealbase projects.

## Key benefits
1. Local development: Set up and run a local Tealbase instance for development and testing.
2. Version control integration: Easily manage database migrations and schema changes with Git-like workflows.
3. Automated deployments: Deploy changes to your Tealbase project with simple CLI commands.
...
7. CI/CD integration: Incorporate Tealbase operations into your continuous integration and deployment pipelines.

## The CLI is particularly valuable for:
- Development teams working on Tealbase projects collaboratively
- DevOps professionals managing Tealbase deployments across multiple environments
- Open-source projects requiring reproducible Tealbase setups
...
- Any application needing a streamlined local-to-production workflow with Tealbase

By leveraging the Tealbase CLI, you can significantly improve your development workflow, ensuring consistency between local and production environments, streamlining deployments, and making it easier to manage complex Tealbase projects. This tool empowers developers to work more efficiently with Tealbase, whether they're building small prototypes or large-scale applications.
`,
    icon: Terminal,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: 'https://www.youtube-nocookie.com/embed/vyHyYpvjaks',
    docsUrl:
      'https://tealbase.com/docs/guides/local-development?queryGroups=package-manager&package-manager=pnpm',
    slug: 'cli',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Tealbase's Management API provides a powerful interface for programmatically managing your Tealbase projects. This feature allows developers and DevOps teams to automate project creation, configuration, and maintenance tasks, enabling more efficient and scalable project management workflows.

## Key benefits
1. Automation: Automate repetitive tasks like project creation and configuration.
2. Scalability: Easily manage multiple Tealbase projects across different environments.
3. CI/CD integration: Incorporate Tealbase project management into your continuous integration and deployment pipelines.
...
- Large organizations managing multiple Tealbase projects
- SaaS platforms offering Tealbase-powered backends to their customers
- DevOps teams implementing infrastructure-as-code practices
- Managed service providers offering Tealbase as part of their stack
...
By utilizing the Tealbase Management API, you can create more efficient, scalable, and automated workflows for managing your Tealbase projects. This feature is especially powerful for organizations dealing with multiple projects or environments, enabling them to maintain consistency, reduce manual errors, and quickly respond to changing project requirements.
`,
    icon: FileCode2,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '/images/features/management-api.png',
    heroImageLight: '/images/features/management-api-light.png',
    docsUrl: 'https://tealbase.com/docs/reference/api/introduction',
    slug: 'management-api',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
...
`,
    ...
    docsUrl:
      'https://tealbase.com/docs/guides/database/postgres/custom-claims-and-role-based-access-control-rbac',
  ...
  // Analytics
  {
    ...
    description: `
Tealbase Reports provide comprehensive insights into your project's performance, usage patterns, and overall health. This feature offers a detailed view of various metrics, helping you optimize your application, troubleshoot issues, and make data-driven decisions about resource allocation and scaling.
...
By leveraging Tealbase Reports, you gain a understanding of your project's performance and usage patterns. This feature empowers you to make informed decisions about scaling, optimization, and resource allocation, ensuring that your application runs efficiently and cost-effectively. Whether you're troubleshooting issues, planning for growth, or optimizing costs, Tealbase Reports provides the insights you need to manage your project effectively.
`,
    icon: BarChart,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '/images/features/reports-and-metrics.png',
    heroImageLight: '/images/features/reports-and-metrics-light.png',
    docsUrl: 'https://tealbase.com/blog/tealbase-reports-and-metrics',
  ...
  },
  {
    ...
    description: `
Tealbase's SOC 2 Compliance demonstrates its commitment to maintaining the highest standards of security, availability, and confidentiality. This certification assures users that Tealbase follows strict information security policies and procedures, encompassing the security, availability, processing, integrity, and confidentiality of customer data.
...
4. Standardized processes: Benefit from Tealbase's adherence to industry-standard security practices.
5. Continuous improvement: Tealbase's commitment to maintaining SOC 2 compliance ensures ongoing security enhancements.
6. Transparency: Access to SOC 2 reports provides insight into Tealbase's security controls.
7. Competitive advantage: Use Tealbase's compliance as a selling point for your own services.
...
Leveraging Tealbase's SOC 2 Compliance involves:
1. Reviewing Tealbase's SOC 2 report to understand its security practices
2. Aligning your application's security practices with Tealbase's standards
3. Utilizing Tealbase's compliant features to enhance your own security posture
4. Communicating the benefits of building on a SOC 2 compliant platform to stakeholders

By building on Tealbase's SOC 2 compliant platform, you gain a significant advantage in terms of security and trust. This compliance demonstrates to your users, partners, and regulators that you take data protection seriously and have chosen a backend platform that adheres to rigorous security standards. Whether you're a startup looking to win enterprise clients or an established company aiming to enhance your security posture, Tealbase's SOC 2 compliance provides a solid foundation for building secure, trustworthy applications.
`,
    icon: ShieldCheck,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '',
    docsUrl: 'https://tealbase.com/docs/guides/security/soc-2-compliance',
  ...
  // Studio
  {
    title: 'Tealbase AI Assistant',
    subtitle: 'Your intelligent companion for managing Postgres databases.',
    description: `
Tealbase AI Assistant is integrated into the Tealbase Dashboard to drastically improve your database management experience. This tool helps streamline your workflow, significantly reducing the time it takes to transition from concept to product.
...
With Tealbase AI Assistant, you gain a powerful ally in your development process, helping you work more efficiently and effectively while keeping you focused on your goals.
`,
    icon: Brain,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: 'https://www.youtube-nocookie.com/embed/_fdP-aaTHgw',
    docsUrl: '/blog/tealbase-ai-assistant-v2',
    slug: 'ai-assistant',
    status: {
      stage: PRODUCT_STAGES.PUBLIC_ALPHA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
The Logs & Analytics feature in Tealbase provides users with comprehensive logging and analytics capabilities, powered by Logflare. This tool enables developers to track and analyze log events from various Tealbase services, such as the API gateway, Postgres databases, Storage, Edge Functions, and more. By leveraging a multi-node Elixir cluster, Tealbase processes billions of log events daily, ensuring that users have access to critical insights for optimizing their applications.
...
4. Customizable Dashboards: Create tailored views within Tealbase Studio to visualize log data and track key performance indicators (KPIs).
...
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/monitoring-troubleshooting/logs',
    slug: 'logs-analytics',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
...
`,
    ...
    docsUrl: 'https://tealbase.com/blog/tealbase-studio-3-0#schema-visualizer',
  ...
  },
  {
    ...
    description: `
Policy Templates provide a library of predefined security policies that can be easily applied to your Tealbase projects. This feature streamlines the process of establishing role-based access control and other security measures, ensuring that best practices are followed consistently across applications.
...
4. User-Friendly: Simplifies policy application through an intuitive interface within the Tealbase Studio.
...
`,
  ...
  },
  {
    ...
    description: `
The SQL Editor in Tealbase Studio provides users with a robust platform for writing, executing, and managing SQL queries directly within their browser. This feature is designed to enhance productivity by offering syntax highlighting, auto-completion, and error detection, making it easier for developers to interact with their databases efficiently.
...
3. User-Friendly Dashboard: Presents findings in an easily digestible format within Tealbase Studio.
...
`,
    ...
    docsUrl: 'https://tealbase.com/blog/security-and-performance-advisor',
...
5. Predefined Roles: Tealbase extends Postgres with a set of predefined roles, simplifying the initial setup for new projects.
...
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/database/postgres/roles',
    slug: 'postgres-roles',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
User Impersonation in Tealbase allows developers to simulate the experience of any user within their application. This feature is particularly useful for testing and debugging, as it enables you to view and interact with your application exactly as a specific user would.

## Key benefits
1. Realistic Testing: Validate user-specific features and permissions by impersonating users directly in Tealbase Studio.
...
`,
    ...
    products: [ADDITIONAL_PRODUCTS.STUDIO],
    heroImage:
      'https://xguihxuzqibwxjnimxev.tealbase.co/storage/v1/object/public/videos/docs/fk-lookup.mp4',
    docsUrl: 'https://tealbase.com/blog/tealbase-studio-2.0#foreign-key-selector',
  ...
  },
  {
    ...
    description: `
Log Drains enable developers to export logs generated by Tealbase products—such as the Database, Storage, Realtime, and Auth—to external destinations like Datadog or custom HTTP endpoints. This feature provides a unified view of logs within existing logging and monitoring systems, allowing teams to build robust alerting and observability pipelines.

## Key benefits
1. Centralized Logging: Consolidate logs from multiple Tealbase services into a single location for easier management and analysis.
...
`,
    ...
    docsUrl: 'https://tealbase.com/blog/log-drains',
    slug: 'log-drains',
    status: {
      stage: PRODUCT_STAGES.PUBLIC_ALPHA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    subtitle: 'Easily integrate Tealbase with your JavaScript applications.',
    description: `
The Tealbase JavaScript Client Library provides a straightforward way to interact with your Tealbase database and services directly from your JavaScript applications. This library simplifies the process of making API calls, managing authentication, and handling real-time updates, making it an essential tool for developers working with Tealbase.

Key benefits:
1. Simplified API Interaction: Easily connect to your Tealbase backend with minimal setup.
...
This feature is particularly valuable for developers looking to build dynamic web applications that leverage the power of Tealbase as a backend service.
`,
    icon: JsIcon,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '',
    docsUrl: 'https://tealbase.com/docs/reference/javascript/start',
  ...
  },
  {
    ...
    subtitle: 'Integrate Tealbase into your Flutter applications effortlessly.',
    description: `
The Tealbase Flutter Client Library allows developers to easily integrate Tealbase into their Flutter applications. This library provides a comprehensive set of tools for managing database interactions, user authentication, and real-time data updates, all tailored for the Flutter framework.

Key benefits:
1. Seamless Integration: Connect your Flutter app to Tealbase with minimal configuration.
...
5. Active Community: Engage with other Flutter developers leveraging Tealbase for their projects.
...
`,
    ...
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '',
    docsUrl: 'https://tealbase.com/docs/reference/dart/start',
  ...
  },
  {
    ...
    subtitle: 'Effortlessly connect your Swift applications to Tealbase.',
    description: `
The Tealbase Swift Client Library provides an easy way for developers to integrate their iOS applications with Tealbase services. This library simplifies database access, user authentication, and real-time data handling, making it an essential tool for Swift developers.

Key benefits:
1. Easy Integration: Quickly connect your Swift app to Tealbase with straightforward setup instructions.
...
5. Supportive Community: Join a community of Swift developers using Tealbase for their app development needs.

This feature is particularly valuable for iOS developers looking to leverage the capabilities of Tealbase in their mobile applications.
`,
    icon: SwiftIcon,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '',
    docsUrl: 'https://tealbase.com/docs/reference/swift/start',
  ...
  },
  {
    ...
    subtitle: 'Integrate Tealbase easily into your Python applications.',
    description: `
The Tealbase Python Client Library enables developers to connect their Python applications with Tealbase effortlessly. This library provides tools for interacting with the database, managing user authentication, and handling real-time updates, tailored specifically for Python developers.

Key benefits:
1. Simple Connection Setup: Easily connect your Python application to Tealbase with minimal configuration.
...
5. Engaged Community Support: Connect with other Python developers utilizing Tealbase in their projects.

This feature is especially beneficial for Python developers looking to build robust applications powered by a scalable backend service like Tealbase.
`,
    icon: PythonIcon,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '',
    docsUrl: 'https://tealbase.com/docs/reference/python/start',
  ...
  },
  {
    ...
    description: `
Tealbase Cron is a Postgres module designed to schedule recurring Jobs with cron syntax directly within your database. Seamlessly integrated into the Tealbase ecosystem, it allows users to automate tasks like executing SQL snippets, calling Database Functions, triggering Tealbase Edge Functions, or syncing with external systems via webhooks.
...
2. Tealbase Integration: Integrates seamlessly with the rest of the Tealbase platform, including Tealbase Edge Functions and Database Webhooks.
...
6. Enhanced Observability: Monitor job history, debug errors, and review logs directly from the Tealbase Dashboard.
...
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/cron',
    slug: 'tealbase-cron',
    status: {
      stage: PRODUCT_STAGES.BETA,
      availableOnSelfHosted: true,
...
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/database/orioledb',
    slug: 'orioledb',
    status: {
      stage: PRODUCT_STAGES.PUBLIC_ALPHA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Tealbase Queues is a native Postgres-based message queue system built on the PGMQ extension, offering developers a seamless way to persist and guarantee delivery of messages, which improves the scalability and resiliency of horizontally deployed services.

Tealbase Queues provides the reliability of Postgres with the simplicity of Tealbase's developer experience, enabling teams to manage queues without maintaining additional infrastructure.
...
`,
    ...
    docsUrl: 'https://tealbase.com/docs/guides/queues',
    slug: 'queues',
    status: {
      stage: PRODUCT_STAGES.PUBLIC_ALPHA,
      availableOnSelfHosted: true,
