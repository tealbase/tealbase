...
export default {
  heroSection: {
    ...
    subheading: (
      <>
        Tealbase is a Firebase alternative. <br className="hidden md:block" />
  ...
  productsSection: {
    products: {
      ...
      'data-api': {
        ...
        label: '',
        url: 'https://tealbase.com/docs/guides/api',
      },
    },
  },
  dashboardFeatures: {
    ...
    tabs: [
      {
        ...
        panel: ({ isDark }: { isDark: boolean }) => (
          <VideoWithHighlights
            video={{
              title: 'Tealbase dashboard table editor',
              sources: [
                {
                  src: `https://xguihxuzqibwxjnimxev.tealbase.co/storage/v1/object/public/videos/marketing/website/tealbase-table-editor${isDark ? '' : '-light'}`,
                  type: 'video/mp4',
                },
              ],
              poster: `/images/index/dashboard/tealbase-table-editor${isDark ? '' : '-light'}.png`,
            }}
          />
        ),
        highlights: [
      ...
      },
      {
        ...
        panel: ({ isDark }: { isDark: boolean }) => (
          <VideoWithHighlights
            video={{
              title: 'Tealbase dashboard SQL editor',
              sources: [
                {
                  src: `https://xguihxuzqibwxjnimxev.tealbase.co/storage/v1/object/public/videos/marketing/website/tealbase-sql-editor${isDark ? '' : '-light'}`,
                  type: 'video/mp4',
                },
              ],
              poster: `/images/index/dashboard/tealbase-sql-editor${isDark ? '' : '-light'}.png`,
            }}
          />
        ),
        highlights: [
      ...
      },
      {
        ...
        panel: ({ isDark }: { isDark: boolean }) => (
          <VideoWithHighlights
            video={{
              title: 'Tealbase dashboard Row Level Security',
              sources: [
                {
                  src: `https://xguihxuzqibwxjnimxev.tealbase.co/storage/v1/object/public/videos/marketing/website/tealbase-rls${isDark ? '' : '-light'}`,
                  type: 'video/mp4',
                },
              ],
              poster: `/images/index/dashboard/tealbase-rls${isDark ? '' : '-light'}.png`,
            }}
          />
        ),
        highlights: [
          ...
          },
          {
            ...
            link: '/docs/guides/auth/social-login#set-up-a-social-provider-with-tealbase-auth',
          },
          {
