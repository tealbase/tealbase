...
export default (isMobile?: boolean) => ({
  metaTitle: 'Tealbase Edge Functions - Deploy JavaScript globally in seconds',
  metaDescription:
      ...
      },
      {
        ...
        paragraph: (
          <>
            The open source{' '}
            <Link
              href="https://github.com/tealbase/edge-runtime/"
              className="underline hover:text-foreground-light transition-colors"
            >
              Edge runtime
            </Link>{' '}
      ...
      },
      {
        ...
        paragraph: (
          <>
            Use the{' '}
            <Link
              href="https://tealbase.com/docs/guides/functions/cicd-workflow"
              className="underline hover:text-foreground-light transition-colors"
            >
              Tealbase CLI with Github actions
            </Link>{' '}
    ...
    features: [
      {
        ...
        paragraph: (
          <>
            ...
            <Link
              href="https://tealbase.com/docs/guides/functions/regional-invocation"
              className="underline hover:text-foreground-light transition-colors"
            >
  ...
  integratesWithTealbase: {
    title: 'Integrates seamlessly with the Tealbase ecosystem',
    useCases: [
      {
        label: 'Zero configuration',
        paragraph: 'Pre-populated environment variables required to access your tealbase project',
        panel: <ZeroConfigPanel />,
      },
      {
        label: 'Connect to your database',
        paragraph:
          'Connect to your Postgres database from an Edge Function by using the tealbase-js client',
      ...
      {
        label: 'Works with Tealbase Auth',
        paragraph: (
          <>
            Edge Functions are designed to work seamlessly with{' '}
            <Link
              href="https://tealbase.com/docs/guides/functions/auth"
              className="underline hover:text-foreground-light transition-colors"
            >
              Tealbase Auth
            </Link>
      ...
      {
        label: 'Works with Tealbase Storage',
        paragraph: (
          <>
            Edge Functions are designed to work seamlessly with{' '}
            <Link
              href="https://tealbase.com/docs/guides/functions/storage-caching"
              className="underline hover:text-foreground-light transition-colors"
            >
              Tealbase Storage
            </Link>
