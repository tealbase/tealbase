...
export default () => ({
  metaTitle: 'Tealbase Cron | Schedule Recurring Jobs in Postgres',
  metaDescription:
    'Tealbase Cron is a Postgres Module that uses the pg_cron database extension to manage recurring tasks. Manage your Cron Jobs using any Postgres tooling.',
  metaImage: '/images/modules/cron/og.png',
  url: 'https://tealbase.com/dashboard/project/_/integrations/cron/overview',
  ...
  heroSection: {
    ...
    subheader: (
      <>
        Tealbase Cron is a Postgres Module that uses the pg_cron database extension to manage
    ...
    cta: {
      ...
      link: 'https://tealbase.com/dashboard/project/_/integrations/cron/overview',
    },
    secondaryCta: {
  ...
  highlightsSection: {
    ...
    highlights: [
      ...
      },
      {
        ...
        paragraph: "Track and debug scheduled Jobs with Tealbase's observability tools.",
        svg: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
  ...
  section2: {
    ...
    subheading:
      'Tealbase Cron provides a clean and simple interface, including cron syntax and natural language options, to create Jobs with ease.',
    image: (
      <Image
        src={{
  ...
  section4: {
    ...
    subheading:
      'Tealbase Cron is integrated with the entire Tealbase suite of tools. Create Jobs to call Database Functions, Tealbase Edge Functions, and even remote webhooks.',
    image: (
      <Image
        src={{
