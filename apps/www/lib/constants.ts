export const APP_NAME = 'Tealbase'
...
export const TWITTER_USER_NAME = 'tealbase'
...
export const TWEET_TEXT =
  'Launch Week 13 is just around the corner at @tealbase. \nClaim your ticket and stay tuned for all the announcements! \n#launchweek'
export const TWEET_TEXT_PLATINUM = `Just conquered a platinum @tealbase Launch Week 13 ticket. Share twice to get one! \n#launchweek`
export const TWEET_TEXT_SECRET = `Found the secret golden ticket for @tealbase's Launch Week 13. \nCan you find it? \n#launchweek`
...
export const LW14_TWEET_TEXT =
  'Launch Week 14 is just around the corner at @tealbase. \nClaim your ticket and stay tuned for all the announcements! \n#launchweek'
export const LW14_TWEET_TEXT_PLATINUM =
  'Just conquered a platinum @tealbase Launch Week 14 ticket. Share twice to get one! \n#launchweek'
export const LW14_TWEET_TEXT_SECRET = `Found the secret golden ticket for @tealbase's Launch Week 14. \nCan you find it? \n#launchweek`
export const LW14_URL = `${SITE_ORIGIN}/launch-week`

export const SITE_NAME = 'Tealbase'
