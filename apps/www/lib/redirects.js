module.exports = [
  ...
  },
  {
    ...
    destination: '/docs/reference/javascript/tealbase-client',
  },
  {
    permanent: false,
  ...
  {
    permanent: false,
    source: '/docs/client/tealbase-client',
    destination: '/docs/reference/javascript/tealbase-client',
  },
  {
    permanent: false,
...

  {
    permanent: false,
    source: '/docs/careers',
    destination: 'https://about.tealbase.com/careers',
  },
  {
    permanent: false,
    source: '/docs/careers/:match*',
    destination: 'https://about.tealbase.com/careers//:match*',
  },
  ...
  {
    permanent: true,
    source: '/docs/reference/javascript/tealbase-client',
    destination: '/docs#reference-documentation',
  },
  {
    permanent: true,
    source: '/join',
    destination: 'https://tealbase.com/',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2022/06/15/blog/2022/06/29/visualizing-tealbase-data-using-metabase',
    destination: '/blog/visualizing-tealbase-data-using-metabase',
  },
  {
    permanent: true,
    source: '/_app',
    destination: 'https://tealbase.com/dashboard',
  },
  {
    permanent: true,
    source: '/blog/2020/05/01/tealbase-alpha-april-2020',
    destination: 'blog/tealbase-alpha-april-2020',
  },
  {
    permanent: true,
    source: '/blog/2020/06/01/tealbase-alpha-may-2020',
    destination: '/blog/tealbase-alpha-may-2020',
  },
  {
    permanent: true,
    source: '/blog/2020/06/15/tealbase-steve-chavez',
    destination: '/blog/tealbase-steve-chavez',
  },
  {
    permanent: true,
    source: '/blog/2020/07/01/tealbase-alpha-june-2020',
    destination: '/blog/tealbase-alpha-june-2020',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2020/08/02/tealbase-alpha-july-2020',
    destination: '/blog/tealbase-alpha-july-2020',
  },
  {
    permanent: true,
    source: '/blog/2020/08/05/tealbase-auth',
    destination: '/blog/tealbase-auth',
  },
  {
    permanent: true,
    source: '/blog/2020/09/03/tealbase-alpha-august-2020',
    destination: '/blog/tealbase-alpha-august-2020',
  },
  {
    permanent: true,
    source: '/blog/2020/09/11/tealbase-hacktoberfest-2020',
    destination: '/blog/tealbase-hacktoberfest-2020',
  },
  {
    permanent: true,
    source: '/blog/2020/10/03/tealbase-alpha-september-2020',
    destination: '/blog/tealbase-alpha-september-2020',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2020/11/02/tealbase-alpha-october-2020',
    destination: '/blog/tealbase-alpha-october-2020',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2020/12/01/tealbase-alpha-november-2020',
    destination: '/blog/tealbase-alpha-november-2020',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2020/12/02/tealbase-striveschool',
    destination: '/blog/tealbase-striveschool',
  },
  {
    permanent: true,
    source: '/blog/2020/12/13/tealbase-dashboard-performance',
    destination: '/blog/tealbase-dashboard-performance',
  },
  {
    permanent: true,
    source: '/blog/2021/01/02/tealbase-beta-december-2020',
    destination: '/blog/tealbase-beta-december-2020',
  },
  {
    permanent: true,
    source: '/blog/2021/02/02/tealbase-beta-january-2021',
    destination: '/blog/tealbase-beta-january-2021',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2021/03/02/tealbase-beta-february-2021',
    destination: '/blog/tealbase-beta-february-2021',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2021/03/11/using-tealbase-replit',
    destination: '/blog/using-tealbase-replit',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2021/03/25/angels-of-tealbase',
    destination: '/blog/angels-of-tealbase',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2021/03/30/tealbase-storage',
    destination: '/blog/tealbase-storage',
  },
  {
    permanent: true,
    source: '/blog/2021/03/31/tealbase-cli',
    destination: '/blog/tealbase-cli',
  },
  {
    permanent: true,
    source: '/blog/2021/04/01/tealbase-nft-marketplace',
    destination: '/blog/tealbase-nft-marketplace',
  },
  {
    permanent: true,
    source: '/blog/2021/04/02/tealbase-dot-com',
    destination: '/blog/tealbase-dot-com',
  },
  {
    permanent: true,
    source: '/blog/2021/04/02/tealbase-pgbouncer',
    destination: '/blog/tealbase-pgbouncer',
  },
  {
    permanent: true,
    source: '/blog/2021/04/02/tealbase-workflows',
    destination: '/blog/tealbase-workflows',
  },
  {
    permanent: true,
    source: '/blog/2021/04/06/tealbase-beta-march-2021',
    destination: '/blog/tealbase-beta-march-2021',
  },
  {
    permanent: true,
    source: '/blog/2021/05/03/tealbase-beta-april-2021',
    destination: '/blog/tealbase-beta-april-2021',
  },
  {
    permanent: true,
    source: '/blog/2021/06/02/tealbase-beta-may-2021',
    destination: '/blog/tealbase-beta-may-2021',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2021/07/02/tealbase-beta-june-2021',
    destination: '/blog/tealbase-beta-june-2021',
  },
  {
    permanent: true,
    source: '/blog/2021/07/22/tealbase-launch-week-sql',
    destination: '/blog/tealbase-launch-week-sql',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2021/07/26/tealbase-community-day',
    destination: '/blog/tealbase-community-day',
  },
  {
    permanent: true,
    source: '/blog/2021/07/26/tealbase-postgres-13',
    destination: '/blog/tealbase-postgres-13',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2021/07/28/mobbin-tealbase-200000-users',
    destination: '/customers/mobbin',
  },
  {
    permanent: true,
    source: '/blog/2021/07/28/tealbase-auth-passwordless-sms-login',
    destination: '/blog/tealbase-auth-passwordless-sms-login',
  },
  {
    permanent: true,
    source: '/blog/2021/07/29/tealbase-reports-and-metrics',
    destination: '/blog/tealbase-reports-and-metrics',
  },
  {
    permanent: true,
    source: '/blog/2021/07/30/1-the-tealbase-hackathon',
    destination: '/blog/the-tealbase-hackathon',
  },
  {
    permanent: true,
    source: '/blog/2021/07/30/tealbase-functions-updates',
    destination: '/blog/tealbase-functions-updates',
  },
  {
    permanent: true,
    source: '/blog/2021/07/30/tealbase-swag-store',
    destination: '/blog/tealbase-swag-store',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2021/08/12/tealbase-beta-july-2021',
    destination: '/blog/tealbase-beta-july-2021',
  },
  {
    permanent: true,
    source: '/blog/2021/09/10/tealbase-beta-august-2021',
    destination: '/blog/tealbase-beta-august-2021',
  },
  {
    permanent: true,
    source: '/blog/2021/09/28/tealbase-hacktoberfest-hackathon-2021',
    destination: '/blog/tealbase-hacktoberfest-hackathon-2021',
  },
  {
    permanent: true,
    source: '/blog/2021/10/04/tealbase-beta-sept-2021',
    destination: '/blog/tealbase-beta-sept-2021',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2021/10/28/tealbase-series-a',
    destination: '/blog/tealbase-series-a',
  },
  {
    permanent: true,
    source: '/blog/2021/11/05/tealbase-beta-october-2021',
    destination: '/blog/tealbase-beta-october-2021',
  },
  {
    permanent: true,
    source: '/blog/2021/11/26/tealbase-how-we-launch',
    destination: '/blog/tealbase-how-we-launch',
  },
  {
    permanent: true,
    source: '/blog/2021/11/26/tealbase-launch-week-the-trilogy',
    destination: '/blog/tealbase-launch-week-the-trilogy',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2021/11/30/tealbase-studio',
    destination: '/blog/tealbase-studio',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2021/12/02/tealbase-acquires-logflare',
    destination: '/blog/tealbase-acquires-logflare',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2021/12/03/tealbase-holiday-hackdays-hackathon',
    destination: '/blog/tealbase-holiday-hackdays-hackathon',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2022/01/20/tealbase-beta-december-2021',
    destination: '/blog/tealbase-beta-december-2021',
  },
  {
    permanent: true,
    source: '/blog/2022/02/22/tealbase-beta-january-2022',
    destination: '/blog/tealbase-beta-january-2022',
  },
  {
    permanent: true,
    source: '/blog/audit',
  ...
  {
    permanent: true,
    source: '/blog/2022/03/25/tealbase-launch-week-four',
    destination: '/blog/tealbase-launch-week-four',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2022/03/30/tealbase-enterprise',
    destination: '/blog/tealbase-enterprise',
  },
  {
    permanent: true,
    source: '/blog/2022/03/31/tealbase-edge-functions',
    destination: '/blog/tealbase-edge-functions',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2022/04/01/tealbase-realtime-with-multiplayer-features',
    destination: '/blog/tealbase-realtime-with-multiplayer-features',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2022/04/20/partner-gallery-works-with-tealbase',
    destination: '/blog/partner-gallery-works-with-tealbase',
  },
  {
    permanent: true,
    source: '/blog/2022/05/26/how-tealbase-accelerates-development-of-all-pull-together',
    destination: '/customers',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2022/06/15/loading-data-tealbase-python',
    destination: '/blog/loading-data-tealbase-python',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2022/06/29/visualizing-tealbase-data-using-metabase',
    destination: '/blog/visualizing-tealbase-data-using-metabase',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2022/07/13/tealbase-auth-helpers-with-sveltekit-support',
    destination: '/blog/tealbase-auth-helpers-with-sveltekit-support',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/2022/08/02/tealbase-flutter-sdk-1-developer-preview',
    destination: '/blog/tealbase-flutter-sdk-1-developer-preview',
  },
  {
    permanent: true,
    source: '/blog/2022/08/03/tealbase-beta-update-july-2022',
    destination: '/blog/tealbase-beta-update-july-2022',
  },
  {
    permanent: true,
    source: '/blog/tealbase-aquires-oriole',
    destination: '/blog/tealbase-acquires-oriole',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/docs/reference/cli/tealbase-help',
    destination: '/docs/reference/cli/global-flags',
  },
  {
    permanent: true,
    source: '/docs/reference/cli/tealbase-db-branch-list',
    destination: '/docs/reference/tealbase-branches-list',
  },
  {
    permanent: true,
    source: '/docs/reference/cli/tealbase-db-branch-create',
    destination: '/docs/reference/tealbase-branches-create',
  },
  {
    permanent: true,
    source: '/docs/reference/cli/tealbase-db-branch-delete',
    destination: '/docs/reference/tealbase-branches-delete',
  },
  {
    permanent: true,
    source: '/docs/reference/cli/tealbase-db-switch',
    destination: '/docs/reference/tealbase-branches-create',
  },
  {
    permanent: true,
    source: '/docs/reference/cli/tealbase-db-changes',
    destination: '/docs/reference/tealbase-db-diff',
  },
  {
    permanent: true,
    source: '/docs/reference/cli/tealbase-db-commit',
    destination: '/docs/reference/tealbase-db-pull',
  },
  {
    permanent: true,
    source: '/docs/reference/cli/tealbase-db-remote-set',
    destination: '/docs/reference/tealbase-link',
  },
  {
    permanent: true,
    source: '/docs/reference/cli/tealbase-db-remote-changes',
    destination: '/docs/reference/tealbase-db-diff',
  },
  {
    permanent: true,
    source: '/docs/reference/cli/tealbase-db-remote-commit',
    destination: '/docs/reference/tealbase-db-pull',
  },
  {
    permanent: true,
    source: '/docs/reference/cli/tealbase-gen-types-typescript',
    destination: '/docs/reference/tealbase-gen-types',
  },
  ...
  // tealbase-js v1 to v2 redirects
  // v1: /auth-update
  // v2: /auth-updateuser
  {
    permanent: true,
  ...
  // tealbase-flutter v0 to v1 redirects
  // v0: /auth-update
  // v1: /auth-updateuser
  {
    permanent: true,
  ...
  },
  {
    permanent: true,
    source: '/sign-in',
    destination: 'https://tealbase.com/dashboard/sign-in',
  },
  {
    permanent: true,
    source: '/sign-up',
    destination: 'https://tealbase.com/dashboard/sign-up',
  },
  {
    permanent: true,
    source: '/forgot-password',
    destination: 'https://tealbase.com/dashboard/forgot-password',
  },
  {
    permanent: true,
    source: '/docs/guides/storage-cdn',
  ...
  },
  {
    permanent: true,
    source: '/projects',
    destination: 'https://tealbase.com/dashboard/projects',
  },
  ...
  },
  {
    ...
    destination: '/docs/guides/platform/ipv4-address#tealbase-and-ipv6-compatibility',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/docs/guides/resources/tealbase-cli',
    destination: '/docs/guides/cli',
  },
  {
    permanent: true,
    source: '/docs/guides/resources/tealbase-cli/local-development',
    destination: '/docs/guides/cli/local-development',
  },
  {
    permanent: true,
    source: '/docs/guides/resources/tealbase-cli/managing-environments',
    destination: '/docs/guides/cli/managing-environments',
  },
  {
    permanent: true,
    source: '/docs/guides/auth/migrations/auth0',
    destination: '/docs/guides/resources/migrating-to-tealbase/auth0',
  },
  {
    permanent: true,
    source: '/docs/guides/migrations/firestore-data',
    destination: '/docs/guides/resources/migrating-to-tealbase/firestore-data',
  },
  {
    permanent: true,
    source: '/docs/guides/migrations/firebase-auth',
    destination: '/docs/guides/resources/migrating-to-tealbase/firebase-auth',
  },
  {
    permanent: true,
    source: '/docs/guides/migrations/firebase-storage',
    destination: '/docs/guides/resources/migrating-to-tealbase/firebase-storage',
  },
  {
    permanent: true,
    source: '/docs/guides/migrations/heroku',
    destination: '/docs/guides/resources/migrating-to-tealbase/heroku',
  },
  {
    permanent: true,
  ...
  },
  {
    ...
    destination: 'https://forms.tealbase.com/enterprise',
  },
  {
    permanent: true,
    source: '/legal/soc2',
    destination: 'https://forms.tealbase.com/soc2',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/mobbin-tealbase-200000-users',
    destination: '/customers/mobbin',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/blog/how-tealbase-accelerates-development-of-all-pull-together',
    destination: '/customers',
  },
  {
    permanent: true,
  ...
  },
  {
    ...
    destination:
      '/docs/guides/platform/oauth-apps/build-a-tealbase-integration#create-an-oauth-app',
  },
  {
    permanent: true,
    source: '/docs/guides/platform/oauth-apps/authorize-an-oauth-app',
    destination: '/docs/guides/platform/oauth-apps/build-a-tealbase-integration',
  },
  ...
  {
    permanent: true,
    source: '/blog/tealbase-ai-content-storm',
    destination: 'https://dev.to/tealbase/ai-ignites-the-rain-content-storm-is-back-kdl',
  },
  {
    permanent: true,
  ...
  {
    permanent: true,
    source: '/docs/guides/resources/migrating-to-tealbase/:path*',
    destination: '/docs/guides/platform/migrating-to-tealbase/:path*',
  },
  {
    permanent: true,
  ...
  },
  {
    ...
    destination: '/docs/guides/integrations/tealbase-marketplace',
  },
  {
    permanent: true,
    source: '/docs/guides/platform/oauth-apps/build-a-tealbase-integration',
    destination: '/docs/guides/integrations/build-a-tealbase-integration',
  },
  {
    permanent: true,
    source: '/docs/guides/platform/oauth-apps/oauth-scopes',
    destination: '/docs/guides/integrations/build-a-tealbase-integration/oauth-scopes',
  },
  {
    permanent: true,
  ...
  },
  {
    ...
    destination: '/docs/guides/platform/billing-on-tealbase',
  },
  {
    permanent: false,
    source: '/docs/guides/platform/org-based-billing#how-billing-is-organized',
    destination: '/docs/guides/platform/billing-on-tealbase#organization-based-billing',
  },
  {
    permanent: false,
    source: '/docs/guides/platform/org-based-billing#quotas-and-features',
    destination: '/docs/guides/platform/billing-on-tealbase#variable-usage-fees-and-quotas',
  },
  {
    permanent: false,
  ...
  },
  {
    ...
    destination: '/docs/guides/platform/billing-on-tealbase#free-plan',
  },
  {
    permanent: false,
...

  {
    permanent: true,
    source: '/changelogpod',
    destination: 'https://forms.tealbase.com/changelog-podcast-sponsorship',
  },
