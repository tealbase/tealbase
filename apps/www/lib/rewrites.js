module.exports = [
  ...
  {
    source: '/ui',
    // FIX: Added a fallback localhost URL for local development
    destination: `${process.env.NEXT_PUBLIC_UI_LIBRARY_URL || 'http://localhost:3001'}`,
  },
  {
    source: '/ui/:path*',
    // FIX: Added a fallback localhost URL for local development
    destination: `${process.env.NEXT_PUBLIC_UI_LIBRARY_URL || 'http://localhost:3001'}/:path*`,
  },
