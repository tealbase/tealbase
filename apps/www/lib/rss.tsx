...
const generateRssItem = (post: any): string => {
  ...
  return `<item>
  <guid>https://tealbase.com${encodedPath}</guid>
  <title>${encodedTitle}</title>
  <link>https://tealbase.com${encodedPath}</link>
...
export const generateRss = (posts: any[], authorID?: string): string => {
  ...
  <rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
    <channel>
      <title>'Postgres | Tealbase Blog</title>
      <link>https://tealbase.com/blog</link>
      <description>Latest Postgres news from ${authorInfo?.author} at Tealbase</description>
      <language>en</language>
      <lastBuildDate>${formattedDate}</lastBuildDate>
      <atom:link href="https://tealbase.com/planetpg-${authorID}-rss.xml" rel="self" type="application/rss+xml"/>
...
`
  ...
  <rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
    <channel>
      <title>Blog - Tealbase</title>
      <link>https://tealbase.com</link>
      <description>Latest news from Tealbase</description>
      <language>en</language>
      <lastBuildDate>${formattedDate}</lastBuildDate>
      <atom:link href="https://tealbase.com/rss.xml" rel="self" type="application/rss+xml"/>
      ${posts.map(generateRssItem).join('')}
    </channel>
  </rss>
`
