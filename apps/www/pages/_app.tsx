  ...
  return (
    <>
      ...
      <DefaultSeo
        ...
        openGraph={{
          type: 'website',
          url: 'https://tealbase.com/',
          site_name: 'Tealbase',
          images: [
            {
              url: `https://tealbase.com${basePath}/images/og/supabase-og.png`,
              width: 800,
              height: 600,
              alt: 'Tealbase Og Image',
            },
          ],
        }}
        twitter={{
