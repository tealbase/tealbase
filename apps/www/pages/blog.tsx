...
function Blog(props: any) {
  ...
  const meta_title = 'Tealbase Blog: Open Source Firebase alternative Blog'
  const meta_description = 'Get all your Tealbase News on the Tealbase blog.'
    ...
    <>
      <NextSeo
        ...
        openGraph={{
          ...
          images: [
            {
              url: `https://tealbase.com/images/og/tealbase-og.png`,
            },
          ],
        }}
        additionalLinkTags={[
          {
            ...
            href: `https://tealbase.com/rss.xml`,
          },
        ]}
      />
      <DefaultLayout>
        <h1 className="sr-only">Tealbase blog</h1>
