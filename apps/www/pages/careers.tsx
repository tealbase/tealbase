...
export function getStaticProps() {
  // Hardcoded job data instead of an API call
  const job_data = {
    jobs: [
      {
        id: 'd8a7b6c5-4e3f-2a19-8b67-12345abcdef',
        title: 'Senior Frontend Engineer',
        location: 'Remote',
        employment: 'Full-time',
        team: 'Engineering',
        jobUrl: 'https://jobs.ashbyhq.com/tealbase/d8a7b6c5-4e3f-2a19-8b67-12345abcdef',
      },
      {
        id: 'f9b8c7d6-5g4h-3b2a-9c78-fedcba54321',
        title: 'Product Designer',
        location: 'Remote (Europe)',
        employment: 'Full-time',
        team: 'Design',
        jobUrl: 'https://jobs.ashbyhq.com/tealbase/f9b8c7d6-5g4h-3b2a-9c78-fedcba54321',
      },
      {
        id: 'a1b2c3d4-e5f6-g7h8-i9j0-klmnopqrst',
        title: 'Backend Engineer (Postgres)',
        location: 'Remote',
        employment: 'Full-time',
        team: 'Engineering',
        jobUrl: 'https://jobs.ashbyhq.com/tealbase/a1b2c3d4-e5f6-g7h8-i9j0-klmnopqrst',
      },
      {
        id: PLACEHOLDER_JOB_ID, // Using the imported constant for the placeholder
        title: 'Future Opportunities',
        location: 'Remote',
        employment: 'General Application',
        team: 'General',
        jobUrl: 'https://jobs.ashbyhq.com/tealbase/form/talent-community-form',
      },
    ],
  }
  ...
  // Hardcoded contributor data instead of an API call
  const contributor_arr = [
    {
      login: 'kiwicopple',
      avatar_url: 'https://avatars.githubusercontent.com/u/1520369?v=4',
      html_url: 'https://github.com/kiwicopple',
    },
    {
      login: 'awalias',
      avatar_url: 'https://avatars.githubusercontent.com/u/1520369?v=4',
      html_url: 'https://github.com/awalias',
    },
    {
      login: 'steve-chavez',
      avatar_url: 'https://avatars.githubusercontent.com/u/123456?v=4',
      html_url: 'https://github.com/steve-chavez',
    },
    {
      login: 'some-other-contributor',
      avatar_url: 'https://avatars.githubusercontent.com/u/7654321?v=4',
      html_url: 'https://github.com/some-other-contributor',
    },
  ]

  const contributor_data = contributor_arr.map(
  ...
  const contributors = contributor_data.filter((contributor: any) =>
    career.contributors.includes(contributor.login)
  )

  contributors.push({
    login: 'ekjotsingh',
    avatar_url: 'https://avatars.githubusercontent.com/u/92289175?v=4',
    html_url: 'https://github.com/ekjotsinghmakhija',
  })
...
const CareerPage: NextPage<CareersPageProps> = ({ jobs, placeholderJob, contributors }) => {
  ...
  const meta_title = 'Careers | Tealbase'
    ...
    <>
      <NextSeo
        ...
        openGraph={{
          title: meta_title,
          description: meta_description,
          url: `https://tealbase.com/careers`,
          images: [
            {
              url: `https://tealbase.com${basePath}/images/career/careers_og.jpg`,
            },
          ],
        }}
      />
      <DefaultLayout>
        <header className="container relative mx-auto px-6 pt-12 pb-8 lg:pt-24 lg:px-16 xl:px-20 text-center space-y-4">
          <h1 className="text-sm text-brand md:text-base">
            <span className="sr-only">Tealbase </span>Careers
          </h1>
                ...
                <div className="md:w-1/2">
                  <div>
                    ...
                    <p className="text-foreground-light text-sm lg:text-base pt-2 sm:max-w-md xl:max-w-lg">
                      Tealbase is a Firebase alternative, built by developers for
                      developers. Tealbase adds auth, realtime, storage, restful APIs, and edge
                      functions to Postgres without a single line of code. Tealbase was born-remote.
            ...
            <SectionContainer className="!pb-0">
              <div className="text-center">
                <h2 className="text-2xl sm:text-3xl xl:text-4xl max-w-[300px] xl:max-w-none mx-auto tracking-[-1px]">
                  1,000 + Contributors building Tealbase
                </h2>
                <p className="text-foreground-light text-xs sm:text-sm lg:text-base sm:max-w-lg lg:max-w-2xl mx-auto pt-3">
                  ...
                  source. We love celebrating everyone who contributes their time to the Tealbase
                  mission.
                </p>
              </div>
          ...
          <SectionContainer>
            ...
            <div className="pt-8 mt-4 border-t border-muted flex flex-col lg:flex-row justify-between items-start lg:items-end gap-2">
              ...
              <Button asChild type="primary">
                <Link
                  href="https://jobs.ashbyhq.com/tealbase/form/talent-community-form"
                  target="_blank"
                >
                  Join community
                </Link>
