...
const Index = ({}: Props) => {
  ...
  const meta_title = "One of the world's fastest-growing open source communities | Tealbase"
  const meta_description =
    'Tealbase is the community that builds the infrastructure for your applications. Build using Tealbase for any size project—from a new startup to even large growing companies'
      ...
      <SectionContainer>
        ...
        <div className="grid grid-cols-2 md:grid-cols-12">
          <div className="col-span-8 ">
            <p>
              <p className="text-foreground text-lg">
                Tealbase is fully remote, with a strong affinity for open source maintainers and
          ...
          <div className=" col-span-4 pt-8 md:mt-0 md:text-right">
            <a href="https://tealbase.com/careers">
