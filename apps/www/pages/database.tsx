...
function Database() {
  ...
  const meta_description =
    'With tealbase’s APIs and easy to use dashboard, it makes designing relational databases easy.'
    ...
    <>
      <NextSeo
        ...
        openGraph={{
          title: meta_title,
          description: meta_description,
          url: `https://tealbase.com/database`,
          images: [
            {
              url: `https://tealbase.com${basePath}/images/product/database/database-og.jpg`,
            },
          ],
        }}
      />
      <DefaultLayout>
        ...
        <ProductHeader
          ...
          subheader={[
            'Every Tealbase project is a dedicated PostgreSQL database, trusted by millions of developers.',
        ...
        <SectionContainer>
          <div className="grid grid-cols-12">
            <div className="col-span-12 mb-10 lg:col-span-3 lg:mb-0">
              ...
              <p className="p">Every Tealbase project is a dedicated Postgres database.</p>
                ...
                <ImageCarousel
                  ...
                  footer={[
                    <TweetCard
                      ...
                      quote="Where has @tealbase been all my life? 😍"
                    />,
                  ]}
                />
              </SectionContainer>
                ...
                <ImageCarousel
                  ...
                  footer={[
                    <TweetCard
                      ...
                      quote="@MongoDB or @MySQL?!?! Please, let me introduce you to @tealbase and the wonderful world of @PostgreSQL before it's too late!!"
                    />,
                  ]}
                />
              </SectionContainer>
          ...
          <APISection
            ...
            text={[
              <p key={0}>
                ...
                product, while Tealbase handles the CRUD.
              </p>,
            ]}
            footer={[
        ...
        <SectionContainer>
          <div className="grid grid-cols-12 lg:gap-16">
            <div className="col-span-12 mb-8 lg:col-span-6 xl:col-span-5">
              ...
              <p className="p">Tealbase works natively with Postgres extensions.</p>
              <p className="p">
              ...
              <FeatureColumn
                ...
                text="We only show a few of the extensions supported by Tealbase here, but we preinstall many more that you can use right away."
              />
