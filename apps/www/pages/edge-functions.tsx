    ...
    <>
      <NextSeo
        ...
        openGraph={{
          title: pageData.metaTitle,
          description: pageData.metaDescription,
          url: `https://tealbase.com/edge-functions`,
          images: [
            {
              url: `https://tealbase.com${basePath}/images/product/functions/functions-og.jpg`,
            },
          ],
        }}
      />
      <DefaultLayout>
        ...
        <ProductHeader
          ...
          footer={
            // FIX: Safely access highlights
            <HighlightColumns highlights={pageData.highlightsSection?.highlights} />
          }
        />
        ...
        <div className="overflow-hidden">
          <SectionContainer className="flex flex-col gap-4 lg:gap-8" id="integrates-with-tealbase">
            {/* FIX: Safely access title and useCases */}
            <h2 className="h2">{pageData.integratesWithTealbase?.title}</h2>
            <TimedAccordionSection tabs={pageData.integratesWithTealbase?.useCases} />
          </SectionContainer>
        </div>
