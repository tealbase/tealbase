...
const OpenSource = () => {
  ...
  const meta_title = pageData.metaTitle || 'Open Source | Tealbase'
  const meta_description =
    pageData.metaDescription ||
    'Tealbase is an open source company, supporting existing open source tools and communities wherever possible.'
