...
function Partner({
  ...
  return (
    <>
      <NextSeo
        title={`${partner.title} | Works With Tealbase`}
        description={partner.description}
        openGraph={{
          title: `${partner.title} | Works With Tealbase`,
          description: partner.description,
          url: `https://tealbase.com/partners/integrations/${partner.slug}`,
          images: [
            {
              ...
              <div className="bg-background hover:border-default-control border-default rounded-2xl border p-10 drop-shadow-sm max-w-5xl mx-auto mt-12">
                <div className="flex flex-row justify-between">
                  <h1 className="text-2xl font-medium self-center">
                    Get started with {partner.title} and Tealbase.
                  </h1>
    ...
    <div className="lg:col-span-3">
      <div className="sticky top-20 flex flex-col gap-4">
        ...
        <p className="text-foreground-light text-sm">
          Third-party integrations and docs are managed by Tealbase partners.
        </p>
      </div>
    </div>
  )
