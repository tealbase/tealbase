...
export async function getStaticProps() {
  ...
  return {
    ...
    // TODO: consider using Next.js' On-demand Revalidation with Tealbase Database Webhooks instead
...
function IntegrationPartnersPage(props: Props) {
  ...
  const meta_description = `Use your favorite tools with Tealbase.`
    ...
    <>
      <NextSeo
        ...
        openGraph={{
          title: meta_title,
          description: meta_description,
          url: `https://tealbase.com/partners/integrations`,
          images: [
            {
