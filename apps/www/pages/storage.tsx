    ...
    <>
      <NextSeo
        ...
        openGraph={{
          title: meta_title,
          description: meta_description,
          url: `https://tealbase.com/storage`,
          images: [
            {
              url: `https://tealbase.com${basePath}/images/product/storage/storage-og.jpg`,
            },
          ],
        }}
      />
        ...
        <SectionContainer>
          <div className="grid grid-cols-12">
            <div className="col-span-12 mb-10 lg:col-span-3 lg:mb-0">
              ...
              <p className="p">
                Integrates well with the rest of Tealbase ecosystem, including Auth and Postgres.
              </p>
            </div>
            ...
            footer={
              <>
                ...
                <ExampleCard
                  ...
                  author_img={'https://avatars.githubusercontent.com/u/54469096'}
                  repo_name={'nextjs-user-management'}
                  repo_url={
                    'https://github.com/tealbase/tealbase/tree/master/examples/user-management/nextjs-user-management'
                  }
                  vercel_deploy_url={
                    'https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Ftealbase%2Ftealbase%2Ftree%2Fmaster%2Fexamples%2Fuser-management%2Fnextjs-user-management&project-name=supabase-nextjs-user-management&repository-name=supabase-nextjs-user-management&integration-ids=oac_VqOgBHqhEoFTPzGkPd7L0iH6&external-id=https%3A%2F%2Fgithub.com%2Fsupabase%2Fsupabase%2Ftree%2Fmaster%2Fexamples%2Fuser-management%2Fnextjs-user-management'
                  }
                  demo_url={''}
                />
              </>
