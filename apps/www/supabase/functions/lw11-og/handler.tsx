...
const STORAGE_URL = 'https://obuldanrptloktxcffvn.tealbase.co/storage/v1/object/public/images/lw11'
...
export async function handler(req: Request) {
  ...
  try {
    ...
    // Get ticket data
    const { data, error } = await tealbaseAdminClient
    ...
    const BACKGROUND = {
      regular: {
        ...
        LOGO: `${STORAGE_URL}/assets/tealbase/tealbase-logo-icon.png`,
      },
      platinum: {
    ...
    const { error: storageError } = await tealbaseAdminClient.storage
      .from('images')
