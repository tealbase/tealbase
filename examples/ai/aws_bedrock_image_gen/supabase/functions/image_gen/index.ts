...
import { createClient } from "npm:@tealbase/tealbase-js";
...
Deno.serve(async (req) => {
  ...
  if (response.$metadata.httpStatusCode === 200) {
    ...
    const { data: upload, error: uploadError } = await tealbaseClient.storage
      .from("images")
...
/* To invoke locally:
  ...
  2. Start with env: `tealbase functions serve --env-file tealbase/.env`
