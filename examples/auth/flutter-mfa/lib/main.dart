...
/// Extract TealbaseClient instance in a handy variable
...
final _router = GoRouter(
  ...
  redirect: (context, state) async {
    ...
    final session = tealbase.auth.currentSession;
    ...
    final assuranceLevelData =
        tealbase.auth.mfa.getAuthenticatorAssuranceLevel();
    ...
    if (assuranceLevelData.currentLevel == AuthenticatorAssuranceLevels.aal1) {
      ...
      final nextLevel =
          tealbase.auth.mfa.getAuthenticatorAssuranceLevel().nextLevel;
