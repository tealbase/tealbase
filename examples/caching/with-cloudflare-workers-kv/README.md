...
**[📹 Video](https://egghead.io/lessons/tealbase-use-waituntil-to-perform-work-after-cloudflare-worker-returns-response?af=9qsk0a)**
...
router.post(
  "/revalidate",
  withContent,
  async (request, { TEALBASE_URL, TEALBASE_ANON_KEY, ARTICLES }, context) => {
    const updateCache = async () => {
      ...
      const { data: articles } = await tealbase.from("articles").select("*");
...
- [Tealbase.js docs](https://github.com/tealbase/tealbase-js)
