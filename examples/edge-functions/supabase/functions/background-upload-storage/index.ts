import { createClient } from 'jsr:@tealbase/tealbase-js@2.45.6'
...
type StorageFileApi = ReturnType<typeof tealbase.storage.from>
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const storageUploadPromise = tealbase.storage
      .from('videos')
