...
const STORAGE_URL = 'https://obuldanrptloktxcffvn.tealbase.co/storage/v1/object/public/images/lw6'
...
const TEAL_CHECKMARK = `${STORAGE_URL}/supaverified.png`
const TEAL_CHECKMARK_GOLD = `${STORAGE_URL}/supaverified_gold.png?v=3`
...
export async function handler(req: Request) {
  ...
  try {
    // Try to get image from Tealbase Storage CDN.
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <img width="32" height="32" src={golden ? TEAL_CHECKMARK_GOLD : TEAL_CHECKMARK} />
                </span>
              </div>
            </div>
            {/* Date  */}
    ...
    const { error } = await tealbaseAdminClient.storage
      .from('images')
