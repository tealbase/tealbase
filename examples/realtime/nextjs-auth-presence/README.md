# Tealbase Realtime Presence API Sample Program

This is an example program for Tealbase Realtime Presence APIs.
User get authenticated using Tealbase Auth API. Once Logged-in you can see which users are 'present' and viewing the page.

- Frontend:
  - Next.js.
  - [Tealbase.js v2 (realtime presence support)](https://tealbase.io/docs/library/getting-started)
- Backend:
  - [app.tealbase.io](https://app.tealbase.io/): hosted postgres database with realtime support.
...
```
NEXT_PUBLIC_TEALBASE_URL=<<insert-your-db-url-here>>

NEXT_PUBLIC_TEALBASE_ANON_KEY=<<insert-your-anon-key-here>>
```
