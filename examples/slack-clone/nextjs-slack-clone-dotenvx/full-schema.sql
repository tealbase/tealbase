--
-- For use with https://github.com/tealbase/tealbase/tree/master/examples/slack-clone/nextjs-slack-clone
--
...
comment on column public.users.id is 'References the internal Tealbase Auth user.';
...
alter publication tealbase_realtime add table public.channels;
alter publication tealbase_realtime add table public.messages;
alter publication tealbase_realtime add table public.users;
