<script lang="ts">
  import type { Provider } from "@tealbase/tealbase-js";
  import { tealbase } from "./db";
  ...
  const handleOAuthLogin = async (provider: Provider) => {
    ...
    // Read more on: https://tealbase.com/docs/guides/auth#third-party-logins
    let { error } = await tealbase.auth.signInWithOAuth({ provider });
