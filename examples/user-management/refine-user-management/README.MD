# Tealbase refine User Management

This repo is a quick sample of how you can get started building apps using [refine](https://github.com/refinedev/refine) and Tealbase: users can sign up with a magic link and then update their account with public profile information, including a profile image.
...
Sign up to Tealbase - [https://app.tealbase.com](https://app.tealbase.com) and create a new project. Wait for your database to start.
...
```
VITE_TEALBASE_URL=YOUR_TEALBASE_URL
VITE_TEALBASE_ANON_KEY=YOUR_TEALBASE_ANON_KEY
```
