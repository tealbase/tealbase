...
[Tealbase](https://tealbase.com) es una alternativa de código abierto a Firebase. Estamos construyendo las características de Firebase utilizando herramientas de código abierto de nivel empresarial.

- [x] Base de datos Postgres alojada. [Documentación](https://tealbase.com/docs/guides/database)
- [x] Autenticación y autorización. [Documentos](https://tealbase.com/docs/guides/auth)
- [x] API autogeneradas.
  - [x] REST. [Docs](https://tealbase.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Documentos](https://tealbase.com/docs/guides/api#graphql-api-overview)
  - [x] Suscripciones en tiempo real. [Documentos](https://tealbase.com/docs/guides/api#realtime-api-overview)
- [x] Funciones.
  - [x] Funciones de base de datos. [Docs](https://tealbase.com/docs/guides/database/functions)
  - [x] Funciones de borde [Docs](https://tealbase.com/docs/guides/functions)
- [x] Almacenamiento de archivos. [Documentos](https://tealbase.com/docs/guides/storage)
- [x] Panel de control
...
Para consultar la documentación completa, visite [tealbase.com/docs](https://tealbase.com/docs)

Para ver cómo contribuir, visite [Getting Started](../DEVELOPERS.md)

## Comunidad y soporte

- [Foro de la comunidad](https://github.com/tealbase/tealbase/discussions). Lo mejor para: ayuda con la construcción, discusión sobre las mejores prácticas de bases de datos.
- [Problemas en GitHub](https://github.com/tealbase/tealbase/issues). Lo mejor para: bugs y errores que encuentres usando Tealbase.
- [Soporte por correo electrónico](https://tealbase.com/docs/support#business-support). Lo mejor para: problemas con tu base de datos o infraestructura.
- [Discord](https://discord.tealbase.com). Lo mejor para: compartir tus aplicaciones y pasar el rato con la comunidad.

## Estado

- [x] Alfa: Estamos probando Tealbase con un grupo cerrado de clientes
- [x] Alfa público: Cualquiera puede registrarse en [tealbase.com/dashboard](https://tealbase.com/dashboard). Pero no te pases, hay algunos problemas
- [Beta pública: Suficientemente estable para la mayoría de los casos de uso no empresariales
- [Público: Disponibilidad general [[status](https://tealbase.com/docs/guides/getting-started/features#feature-status)]
...
Tealbase es una combinación de herramientas de código abierto. Estamos construyendo las características de Firebase utilizando productos de código abierto de nivel empresarial. Si las herramientas y las comunidades existen, con una licencia abierta MIT, Apache 2 o equivalente, utilizaremos y daremos soporte a esa herramienta. Si la herramienta no existe, la construimos y la desarrollamos nosotros mismos. Tealbase no es un mapeo 1 a 1 de Firebase. Nuestro objetivo es ofrecer a los desarrolladores una experiencia similar a la de Firebase utilizando herramientas de código abierto.

**Arquitectura**

Tealbase es una [plataforma alojada](https://tealbase.com/dashboard). Puedes registrarte y empezar a usar Tealbase sin instalar nada.
También puede [autoalojarse](https://tealbase.com/docs/guides/hosting/overview) y [desarrollar localmente](https://tealbase.com/docs/guides/local-development).
...
- [pg_graphql](http://github.com/tealbase/pg_graphql/) una extensión de PostgreSQL que expone una API GraphQL
- [Storage](https://github.com/tealbase/storage-api) proporciona una interfaz RESTful para gestionar archivos almacenados en S3, usando Postgres para gestionar permisos.
- [postgres-meta](https://github.com/tealbase/postgres-meta) es una API RESTful para gestionar tu Postgres, permitiéndote obtener tablas, añadir roles, ejecutar consultas, etc.
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Idioma</th>
    <th>Cliente</th>
    <th colspan="5">Feature-Clients (incluido en el cliente Tealbase)</th>
  </tr>
...
- [Inglés](https://github.com/tealbase/tealbase)
...
[![Nuevo Patrocinador](https://user-images.githubusercontent.com/10214025/90518111-e74bbb00-e198-11ea-8f88-c9e3c1aa4b5b.png)](https://github.com/sponsors/tealbase)
