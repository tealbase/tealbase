...
[Tealbase](https://tealbase.com) on avatud lähtekoodiga Firebase'i alternatiiv. Me ehitame Firebase'i funktsioonid, kasutades ettevõtlusklassi avatud lähtekoodiga tööriistu.

- [x] Hostitud Postgres andmebaas. [Dokumendid](https://tealbase.com/docs/guides/database)
- [x] Autentimine ja autoriseerimine. [Dokumendid](https://tealbase.com/docs/guides/auth)
- [x] Automaatselt genereeritud APId.
  - [x] REST. [Dokumendid](https://tealbase.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Dokumendid](https://tealbase.com/docs/guides/api#graphql-api-overview)
  - [x] Reaalajas toimivad tellimused. [Dokumendid](https://tealbase.com/docs/guides/api#realtime-api-overview)
- [x] Funktsioonid.
  - [x] Andmebaasi funktsioonid. [Dokumendid](https://tealbase.com/docs/guides/database/functions)
  - [x] Edge Functions [Docs](https://tealbase.com/docs/guides/functions)
- [x] Faili salvestamine. [Dokumendid](https://tealbase.com/docs/guides/storage)
- [x] Armatuurlaud
...
Täieliku dokumentatsiooni saamiseks külastage [tealbase.com/docs](https://tealbase.com/docs)

Et näha, kuidas panustada, külastage [Getting Started](../DEVELOPERS.md)

## Kogukond ja tugi

- [Ühenduse foorum](https://github.com/tealbase/tealbase/discussions). Parim: abi ehitamisel, arutelu andmebaasi parimate tavade üle.
- [GitHub Issues](https://github.com/tealbase/tealbase/issues). Parim lahendus: vead ja vead, millega Tealbase'i kasutades kokku puutute.
- [E-posti tugi](https://tealbase.com/docs/support#business-support). Parim lahendus: probleemid andmebaasi või infrastruktuuriga.
- [Discord](https://discord.tealbase.com). Parim: oma rakenduste jagamiseks ja kogukonnaga suhtlemiseks.

## Staatus

- [x] Alpha: Me testime Tealbase'i suletud kliendikogumiga
- [x] Avalik Alpha: Igaüks saab registreeruda aadressil [tealbase.com/dashboard](https://tealbase.com/dashboard). Kuid olge meiega ettevaatlikud, seal on mõned veidrused
- [x] Avalik beeta: Piisavalt stabiilne enamiku mitte-ettevõtluskasutuse jaoks
- [ ] Avalik: Üldine kättesaadavus [[status](https://tealbase.com/docs/guides/getting-started/features#feature-status)]
...
Tealbase on avatud lähtekoodiga tööriistade kombinatsioon. Me ehitame Firebase'i funktsioonid üles, kasutades ettevõtte kvaliteediga avatud lähtekoodiga tooteid. Kui tööriistad ja kogukonnad on olemas MIT, Apache 2 või samaväärse avatud litsentsiga, kasutame ja toetame seda tööriista. Kui tööriista ei ole olemas, siis ehitame selle ise ja kasutame avatud lähtekoodi. Tealbase ei ole Firebase'i 1:1 kaardistus. Meie eesmärk on pakkuda arendajatele Firebase'ile sarnast arenduskogemust, kasutades avatud lähtekoodiga tööriistu.

**Arhitektuur**

Tealbase on [hostitud platvorm](https://tealbase.com/dashboard). Võite registreeruda ja alustada Tealbase'i kasutamist ilma midagi installimata.
Võite ka [ise hostida](https://tealbase.com/docs/guides/hosting/overview) ja [arendada lokaalselt](https://tealbase.com/docs/guides/local-development).

![Arhitektuur](https://github.com/tealbase/tealbase/blob/master/apps/docs/public/img/tealbase-architecture.svg)
...
- [Realtime](https://github.com/tealbase/realtime) on Elixir server, mis võimaldab kuulata PostgreSQL-i sisestusi, uuendusi ja kustutusi veebisokkide abil. Realtime küsib Postgres'i sisseehitatud replikatsioonifunktsioone andmebaasi muudatuste kohta, konverteerib muudatused JSON-iks ja edastab seejärel JSON-i üle websocketi volitatud klientidele.
- [PostgREST](http://postgrest.org/) on veebiserver, mis muudab teie PostgreSQL andmebaasi otse RESTful API-ks
- [pg_graphql](http://github.com/tealbase/pg_graphql/) on PostgreSQLi laiendus, mis avab GraphQL API
- [Storage](https://github.com/tealbase/storage-api) pakub RESTful liidest S3-s salvestatud failide haldamiseks, kasutades Postgres'i õiguste haldamiseks.
- [postgres-meta](https://github.com/tealbase/postgres-meta) on RESTful API oma Postgres'i haldamiseks, mis võimaldab tabelite hankimist, rollide lisamist ja päringute käivitamist jne.
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Keel</th>
    <th>Klient</th>
    <th colspan="5">Funktsioon-kliendid (komplekteeritud Tealbase'i kliendiga)</th>
  </tr>
...
- [inglise keel](https://github.com/tealbase/tealbase)
...
[![Uus sponsor](https://user-images.githubusercontent.com/10214025/90518111-e74bbb00-e198-11ea-8f88-c9e3c1aa4b5b.png)](https://github.com/sponsors/tealbase)
