...
[Tealbase](https://tealbase.com) adalah alternatif Firebase open source. Kami membangun fitur-fitur Firebase menggunakan alat bantu open source tingkat perusahaan.

- [x] Basis Data Postgres yang dihosting. [Dokumen](https://tealbase.com/docs/guides/database)
- [x] Otentikasi dan Otorisasi. [Dokumen](https://tealbase.com/docs/guides/auth)
- [x] API yang dibuat secara otomatis.
  - [x] REST. [Dokumen](https://tealbase.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Dokumen](https://tealbase.com/docs/guides/api#graphql-api-overview)
  - [x] Langganan realtime. [Dokumen](https://tealbase.com/docs/guides/api#realtime-api-overview)
- [x] Fungsi-fungsi.
  - [x] Fungsi-fungsi Basis Data. [Dokumen](https://tealbase.com/docs/guides/database/functions)
  - [x] Fungsi Tepi [Dokumen](https://tealbase.com/docs/guides/functions)
- [x] Penyimpanan File. [Dokumen](https://tealbase.com/docs/guides/storage)
- [x] Dasbor

![Dasbor Tealbase](https://raw.githubusercontent.com/tealbase/tealbase/master/apps/www/public/images/github/tealbase-dashboard.png)

## Dokumentasi

Untuk dokumentasi lengkap, kunjungi [tealbase.com/docs](https://tealbase.com/docs)

Untuk melihat bagaimana cara berkontribusi, kunjungi [Memulai](../DEVELOPERS.md)

## Komunitas &amp; Dukungan

- [Forum Komunitas](https://github.com/tealbase/tealbase/discussions). Paling baik untuk: bantuan dalam membangun, diskusi tentang praktik terbaik basis data.
- [Masalah GitHub](https://github.com/tealbase/tealbase/issues). Paling baik untuk: bug dan kesalahan yang Anda temui saat menggunakan Tealbase.
- [Dukungan Email](https://tealbase.com/docs/support#business-support). Terbaik untuk: masalah dengan basis data atau infrastruktur Anda.
- [Discord](https://discord.tealbase.com). Terbaik untuk: berbagi aplikasi Anda dan bergaul dengan komunitas.

## Status

- [x] Alpha: Kami sedang menguji Tealbase dengan sekumpulan pelanggan tertutup
- [x] Alpha Publik: Siapa pun dapat mendaftar di [tealbase.com/dashboard](https://tealbase.com/dashboard). Tapi jangan khawatir, ada beberapa hal yang perlu diperhatikan
- [x] Public Beta: Cukup stabil untuk sebagian besar kasus penggunaan non-perusahaan
- [Publik: Ketersediaan Umum [[status](https://tealbase.com/docs/guides/getting-started/features#feature-status)]
...
Tealbase adalah kombinasi dari alat sumber terbuka. Kami membangun fitur-fitur Firebase menggunakan produk open source kelas enterprise. Jika alat dan komunitasnya ada, dengan lisensi MIT, Apache 2, atau lisensi terbuka yang setara, kami akan menggunakan dan mendukung alat tersebut. Jika alat tersebut tidak ada, kami akan membangun dan mengembangkannya sendiri. Tealbase bukanlah pemetaan 1-ke-1 dari Firebase. Tujuan kami adalah untuk memberikan pengalaman pengembang seperti Firebase dengan menggunakan alat sumber terbuka.

**Arsitektur**

Tealbase adalah [platform yang di-host](https://tealbase.com/dashboard). Anda bisa mendaftar dan mulai menggunakan Tealbase tanpa menginstal apa pun.
Anda juga bisa [menghosting sendiri](https://tealbase.com/docs/guides/hosting/overview) dan [mengembangkan secara lokal](https://tealbase.com/docs/guides/local-development).

![Arsitektur](https://github.com/tealbase/tealbase/blob/master/apps/docs/public/img/tealbase-architecture.svg)
...
- [Realtime](https://github.com/tealbase/realtime) adalah server Elixir yang memungkinkan Anda untuk mendengarkan penyisipan, pembaruan, dan penghapusan PostgreSQL menggunakan websocket. Realtime melakukan polling terhadap fungsionalitas replikasi bawaan Postgres untuk perubahan database, mengkonversi perubahan ke JSON, kemudian menyiarkan JSON melalui websockets ke klien yang berwenang.
...
- [pg_graphql](http://github.com/tealbase/pg_graphql/) ekstensi PostgreSQL yang mengekspos API GraphQL
- [Storage](https://github.com/tealbase/storage-api) menyediakan antarmuka RESTful untuk mengelola File yang disimpan di S3, menggunakan Postgres untuk mengelola izin.
- [postgres-meta](https://github.com/tealbase/postgres-meta) adalah API RESTful untuk mengelola Postgres Anda, yang memungkinkan Anda untuk mengambil tabel, menambahkan peran, dan menjalankan kueri, dll.
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Bahasa</th>
    <th>Klien</th>
    <th colspan="5">Klien-Fitur (dibundel dalam klien Tealbase)</th>
  </tr>
...
- [Bahasa Inggris / English](https://github.com/tealbase/tealbase)
...
[![Sponsor Baru](https://user-images.githubusercontent.com/10214025/90518111-e74bbb00-e198-11ea-8f88-c9e3c1aa4b5b.png)](https://github.com/sponsors/tealbase)
