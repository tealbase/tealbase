...
[Tealbase](https://tealbase.com) ir atvērtā koda Firebase alternatīva. Mēs veidojam Firebase funkcijas, izmantojot uzņēmumu klases atvērtā pirmkoda rīkus.

- [x] Hosted Postgres datubāze. [Dokumenti](https://tealbase.com/docs/guides/database)
- [x] Autentifikācija un autorizācija. [Dokumenti](https://tealbase.com/docs/guides/auth)
- [x] Automātiski ģenerēti API.
  ...
  - [x] Reāllaika abonēšana. [Dokumenti](https://tealbase.com/docs/guides/api#realtime-api-overview)
- [x] Funkcijas.
  - [x] Datubāzes funkcijas. [Dokumenti](https://tealbase.com/docs/guides/database/functions)
  - [x] Edge funkcijas [Dokumenti](https://tealbase.com/docs/guides/functions)
- [x] Failu glabāšana. [Dokumenti](https://tealbase.com/docs/guides/storage)
- [x] Vadības panelis
...
Pilnu dokumentāciju skatīt [tealbase.com/docs](https://tealbase.com/docs)

Lai uzzinātu, kā veikt iemaksas, apmeklējiet [Getting Started](../DEVELOPERS.md)

## Kopiena un atbalsts

- [Kopienas forums](https://github.com/tealbase/tealbase/discussions). Vislabāk piemērots: palīdzībai veidošanā, diskusijām par datubāzes paraugpraksi.
- [GitHub Issues](https://github.com/tealbase/tealbase/issues). Vislabākais: kļūdas un kļūdas, ar kurām jūs sastopaties, izmantojot Tealbase.
- [E-pasta atbalsts](https://tealbase.com/docs/support#business-support). Vislabāk piemērots: problēmām ar jūsu datu bāzi vai infrastruktūru.
- [Discord](https://discord.tealbase.com). Vislabākais: lai dalītos ar savām lietojumprogrammām un komunicētu ar kopienu.

## Statuss

- [x] Alfa: Mēs testējam Tealbase ar slēgtu klientu kopu
- [x] Publiskā alfa versija: [tealbase.com/dashboard](https://tealbase.com/dashboard). Bet nesteidzieties, ir dažas nepilnības
- [x] Publiskā beta versija: Pietiekami stabila lielākajai daļai ar uzņēmumu nesaistītu lietošanas gadījumu
- [ ] Publisks: Vispārēja pieejamība [[statuss](https://tealbase.com/docs/guides/getting-started/features#feature-status)]]
...
Tealbase ir atvērtā koda rīku kombinācija. Mēs veidojam Firebase funkcijas, izmantojot atvērtā pirmkoda produktus, kas paredzēti uzņēmumiem. Ja pastāv rīki un kopienas ar MIT, Apache 2 vai līdzvērtīgu atvērto licenci, mēs izmantosim un atbalstīsim šo rīku. Ja rīks nepastāv, mēs paši to izveidosim un izveidosim ar atklātā pirmkoda licenci. Tealbase nav Firebase kartēšana 1 pret 1. Mūsu mērķis ir nodrošināt izstrādātājiem Firebase līdzīgu izstrādātāja pieredzi, izmantojot atvērtā koda rīkus.

**Arhitektūra**

Tealbase ir [izvietota platforma](https://tealbase.com/dashboard). Jūs varat reģistrēties un sākt izmantot Tealbase, neko neinstalējot.
Jūs varat arī [pašmāju resursus](https://tealbase.com/docs/guides/hosting/overview) un [izstrādāt lokāli](https://tealbase.com/docs/guides/local-development).

![Arhitektūra](https://github.com/tealbase/tealbase/blob/master/apps/docs/public/img/tealbase-architecture.svg)
...
- [Realtime](https://github.com/tealbase/realtime) ir Elixir serveris, kas ļauj klausīties PostgreSQL ievadi, atjauninājumi un dzēšana, izmantojot websockets. Realtime aptaujā Postgres iebūvēto replikācijas funkcionalitāti par izmaiņām datubāzē, konvertē izmaiņas JSON un pēc tam pārraida JSON pa websockets autorizētiem klientiem.
- [PostgREST](http://postgrest.org/) ir tīmekļa serveris, kas pārvērš PostgreSQL datubāzi tieši RESTful API
- [pg_graphql](http://github.com/tealbase/pg_graphql/) ir PostgreSQL paplašinājums, kas atklāj GraphQL API
- [Storage](https://github.com/tealbase/storage-api) nodrošina RESTful saskarni S3 glabātu failu pārvaldībai, izmantojot Postgres atļauju pārvaldībai.
- [postgres-meta](https://github.com/tealbase/postgres-meta) ir RESTful API jūsu Postgres pārvaldībai, kas ļauj jums iegūt tabulas, pievienot lomas, veikt pieprasījumus utt.
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Valoda</th>
    <th>Klients</th>
    <th colspan="5">Funkciju klienti (komplektā ar Tealbase klientu)</th>
  </tr>
...
- [angļu valodā](https://github.com/tealbase/tealbase)
...
[![Jauns sponsors](https://user-images.githubusercontent.com/10214025/90518111-e74bbb00-e198-11ea-8f88-c9e3c1aa4b5b.png)](https://github.com/sponsors/tealbase)
