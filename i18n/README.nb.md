...
[Tealbase](https://tealbase.com) er et alternativ til Firebase med åpen kildekode. Vi bygger funksjonene i Firebase ved hjelp av åpen kildekode-verktøy for bedrifter.

- [x] Hostet Postgres-database. [Dokumenter](https://tealbase.com/docs/guides/database)
- [x] Autentisering og autorisasjon. [Dokumenter](https://tealbase.com/docs/guides/auth)
- [x] Autogenererte API-er.
  - [x] REST. [Dokumenter](https://tealbase.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Dokumenter](https://tealbase.com/docs/guides/api#graphql-api-overview)
  - [x] Sanntidsabonnementer. [Dokumenter](https://tealbase.com/docs/guides/api#realtime-api-overview)
- [x] Funksjoner.
  - [x] Databasefunksjoner. [Dokumenter](https://tealbase.com/docs/guides/database/functions)
  - [x] Edge-funksjoner [Dokumenter](https://tealbase.com/docs/guides/functions)
- [x] Lagring av filer. [Dokumenter](https://tealbase.com/docs/guides/storage)
- [x] Dashbord

tealbase Dashboard](https://raw.githubusercontent.com/tealbase/tealbase/master/apps/www/public/images/github/tealbase-dashboard.png) [x] [x] [x] [x][Tealbase Dashboard](https://raw.githubusercontent.com/tealbase/tealbase/master/apps/www/public/images/github/tealbase-dashboard.png)

## Dokumentasjon

For fullstendig dokumentasjon, besøk [tealbase.com/docs](https://tealbase.com/docs)

For å se hvordan du kan bidra, gå til [Getting Started](../DEVELOPERS.md)

## Fellesskap og støtte

- [Community Forum](https://github.com/tealbase/tealbase/discussions). Best for: hjelp med å bygge, diskusjon om beste praksis for databaser.
- [GitHub Issues](https://github.com/tealbase/tealbase/issues). Best for: feil og feil du støter på ved bruk av Tealbase.
- [E-poststøtte](https://tealbase.com/docs/support#business-support). Best for: problemer med databasen eller infrastrukturen din.
- [Discord](https://discord.tealbase.com). Best for: å dele applikasjonene dine og henge med fellesskapet.

## Status

- [x] Alpha: Vi tester Tealbase med en lukket gruppe kunder
- [x] Offentlig Alpha: Alle kan registrere seg på [tealbase.com/dashboard](https://tealbase.com/dashboard). Men vær snill med oss, det er noen små problemer
- [x] Offentlig beta: Stabilt nok for de fleste brukstilfeller som ikke er for bedrifter
- [ ] Offentlig: Generell tilgjengelighet [[status](https://tealbase.com/docs/guides/getting-started/features#feature-status)]
...
Tealbase er en kombinasjon av verktøy med åpen kildekode. Vi bygger funksjonene i Firebase ved hjelp av åpen kildekode-produkter på bedriftsnivå. Hvis verktøyene og fellesskapene finnes, med en MIT, Apache 2 eller tilsvarende åpen lisens, vil vi bruke og støtte det verktøyet. Hvis verktøyet ikke finnes, bygger vi det selv med åpen kildekode. Tealbase er ikke en 1-til-1-kartlegging av Firebase. Målet vårt er å gi utviklere en Firebase-lignende utvikleropplevelse ved hjelp av verktøy med åpen kildekode.

\*\*Arkitektur

Tealbase er en [vertsplattform](https://tealbase.com/dashboard). Du kan registrere deg og begynne å bruke Tealbase uten å installere noe.
Du kan også [selv være vert](https://tealbase.com/docs/guides/hosting/overview) og [utvikle lokalt](https://tealbase.com/docs/guides/local-development).
...
- [Realtime](https://github.com/tealbase/realtime) er en Elixir-server som lar deg lytte til PostgreSQL-innlegg, oppdateringer og slettinger ved hjelp av websockets. Realtime polls Postgres' innebygde replikeringsfunksjonalitet for databaseendringer, konverterer endringer til JSON og sender deretter JSON over websockets til autoriserte klienter.
- [PostgREST](http://postgrest.org/) er en webserver som gjør PostgreSQL-databasen din direkte om til et RESTful API
- [pg_graphql](http://github.com/tealbase/pg_graphql/) en PostgreSQL-utvidelse som eksponerer et GraphQL API
- [Storage](https://github.com/tealbase/storage-api) gir et RESTful-grensesnitt for å administrere filer som er lagret i S3, ved hjelp av Postgres for å administrere tillatelser.
- [postgres-meta](https://github.com/tealbase/postgres-meta) er et RESTful API for å administrere Postgres, slik at du kan hente tabeller, legge til roller og kjøre spørringer osv.
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Språk</th>
    <th>Klient</th>
    <th colspan="5">Funksjonsklienter (inkludert i Tealbase-klienten)</th>
  </tr>
