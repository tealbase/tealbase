...
[Tealbase](https://tealbase.com) to alternatywa dla Firebase o otwartym kodzie źródłowym. Tworzymy funkcje Firebase przy użyciu narzędzi open source klasy korporacyjnej.

- [x] hostowana baza danych Postgres [x]. [Dokumenty](https://tealbase.com/docs/guides/database)
- [x] uwierzytelnianie i autoryzacja [x]. [Dokumenty](https://tealbase.com/docs/guides/auth)
- [x] Automatycznie generowane interfejsy API.
  ...
  - [x] Subskrypcje w czasie rzeczywistym. [Docs](https://tealbase.com/docs/guides/api#realtime-api-overview)
- [x] Funkcje.
  - [x] Funkcje bazy danych. [Docs](https://tealbase.com/docs/guides/database/functions)
  - [x] Funkcje brzegowe [Docs](https://tealbase.com/docs/guides/functions)
- przechowywanie plików [x]. [Docs](https://tealbase.com/docs/guides/storage)
- [Pulpit nawigacyjny

![Pulpit nawigacyjny Tealbase](https://raw.githubusercontent.com/tealbase/tealbase/master/apps/www/public/images/github/tealbase-dashboard.png)

## Dokumentacja

Pełna dokumentacja znajduje się na stronie [tealbase.com/docs](https://tealbase.com/docs)

Aby zobaczyć, jak wnieść swój wkład, odwiedź [Getting Started](../DEVELOPERS.md)

## Społeczność i wsparcie

- [Forum społeczności](https://github.com/tealbase/tealbase/discussions). Najlepsze do: pomocy w budowaniu, dyskusji o najlepszych praktykach dotyczących baz danych.
- [GitHub Issues](https://github.com/tealbase/tealbase/issues). Najlepszy do: błędów i błędów napotkanych podczas korzystania z Tealbase.
- [Email Support](https://tealbase.com/docs/support#business-support). Najlepsze w przypadku: problemów z bazą danych lub infrastrukturą.
- [Discord](https://discord.tealbase.com). Najlepszy do: dzielenia się aplikacjami i spędzania czasu ze społecznością.

## Status

- [x] Alpha: Testujemy Tealbase z zamkniętą grupą klientów
- [x] Publiczna wersja alfa: Każdy może zarejestrować się na stronie [tealbase.com/dashboard](https://tealbase.com/dashboard). Ale spokojnie, jest kilka niedociągnięć
- [x] Publiczna beta: Wystarczająco stabilna dla większości przypadków użycia innych niż korporacyjne
- [] Public: Ogólna dostępność [[status](https://tealbase.com/docs/guides/getting-started/features#feature-status)]
...
Tealbase to połączenie narzędzi open source. Tworzymy funkcje Firebase przy użyciu produktów open source klasy korporacyjnej. Jeśli narzędzia i społeczności istnieją, z licencją MIT, Apache 2 lub równoważną otwartą licencją, będziemy używać i wspierać to narzędzie. Jeśli narzędzie nie istnieje, sami je tworzymy i otwieramy. Tealbase nie jest odwzorowaniem Firebase 1 do 1. Naszym celem jest zapewnienie programistom doświadczenia podobnego do Firebase przy użyciu narzędzi open source.

**Architektura**

Tealbase jest [platformą hostowaną](https://tealbase.com/dashboard). Możesz zarejestrować się i zacząć korzystać z Tealbase bez instalowania czegokolwiek.
Możesz także [self-host](https://tealbase.com/docs/guides/hosting/overview) i [rozwijać lokalnie](https://tealbase.com/docs/guides/local-development).

![Architektura](https://github.com/tealbase/tealbase/blob/master/apps/docs/public/img/tealbase-architecture.svg)
...
- [pg_graphql](http://github.com/tealbase/pg_graphql/) rozszerzenie PostgreSQL, które udostępnia GraphQL API
- [Storage](https://github.com/tealbase/storage-api) zapewnia interfejs RESTful do zarządzania plikami przechowywanymi w S3, wykorzystując Postgres do zarządzania uprawnieniami.
- [postgres-meta](https://github.com/tealbase/postgres-meta) to interfejs API RESTful do zarządzania Postgres, umożliwiający pobieranie tabel, dodawanie ról, uruchamianie zapytań itp.
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Język</th>
    <th>Klient</th>
    <th colspan="5">Klienty funkcji (dołączone do klienta Tealbase)</th>
  </tr>
...
- [angielski](https://github.com/tealbase/tealbase)
...
[![Nowy sponsor](https://user-images.githubusercontent.com/10214025/90518111-e74bbb00-e198-11ea-8f88-c9e3c1aa4b5b.png)](https://github.com/sponsors/tealbase)
