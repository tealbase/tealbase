...
[Tealbase](https://tealbase.com) é uma alternativa open source ao Firebase. Estamos a construir as funcionalidades do Firebase usando ferramentas open source de nível empresarial.

- [x] Base de dados Postgres alojada. [Docs](https://tealbase.com/docs/guides/database)
- [x] Autenticação e autorização. [Docs](https://tealbase.com/docs/guides/auth)
- [x] APIs geradas automaticamente.
  ...
  - [x] Assinaturas em tempo real. [Docs](https://tealbase.com/docs/guides/api#realtime-api-overview)
- [x] Funções.
  - [x] Funções de base de dados. [Docs](https://tealbase.com/docs/guides/database/functions)
  - [x] Funções de Borda [Docs](https://tealbase.com/docs/guides/functions)
- [x] Armazenamento de Ficheiros. [Docs](https://tealbase.com/docs/guides/storage)
...
Para documentação completa, visite [tealbase.com/docs](https://tealbase.com/docs)

Para ver como contribuir, visite [Getting Started](../DEVELOPERS.md)

## Comunidade & Suporte

- [Fórum da Comunidade](https://github.com/tealbase/tealbase/discussions). Melhor para: ajuda com a construção, discussão sobre as melhores práticas de banco de dados.
- [Problemas no GitHub](https://github.com/tealbase/tealbase/issues). Melhor para: bugs e erros que encontra ao usar o Tealbase.
- [Suporte por Email](https://tealbase.com/docs/support#business-support). Melhor para: problemas com a sua base de dados ou infra-estrutura.
- [Discord](https://discord.tealbase.com). Ideal para: partilhar as suas aplicações e conviver com a comunidade.

## Status

- [x] Alfa: Estamos a testar o Tealbase com um conjunto fechado de clientes
- [x] Alfa Público: Qualquer pessoa pode inscrever-se em [tealbase.com/dashboard](https://tealbase.com/dashboard). Mas vá com calma, ainda há alguns problemas
- [x] Beta Público: Estável o suficiente para a maioria dos casos de uso não empresarial
- [ ] Público: Disponibilidade geral [[status](https://tealbase.com/docs/guides/getting-started/features#feature-status)]
...
O Tealbase é uma combinação de ferramentas de código aberto. Estamos a construir as funcionalidades do Firebase usando produtos open source de nível empresarial. Se as ferramentas e as comunidades existirem, com uma licença MIT, Apache 2, ou equivalente, nós usaremos e apoiaremos essa ferramenta. Se a ferramenta não existir, nós próprios a construímos e tornamos o código aberto. O Tealbase não é um mapeamento 1 para 1 do Firebase. O nosso objectivo é dar aos programadores uma experiência semelhante à do Firebase usando ferramentas de código aberto.

**Arquitectura**

Tealbase é uma [plataforma alojada](https://tealbase.com/dashboard). Pode registar-se e começar a usar o Tealbase sem instalar nada.
Pode também [auto-hospedar](https://tealbase.com/docs/guides/hosting/overview) e [desenvolver localmente](https://tealbase.com/docs/guides/local-development).
...
- [pg_graphql](http://github.com/tealbase/pg_graphql/) uma extensão do PostgreSQL que expõe uma API GraphQL
- [Storage](https://github.com/tealbase/storage-api) fornece uma interface RESTful para gerir ficheiros armazenados no S3, utilizando o Postgres para gerir permissões.
- [postgres-meta](https://github.com/tealbase/postgres-meta) é uma API RESTful para gerenciar seu Postgres, permitindo que você busque tabelas, adicione funções e execute consultas, etc.
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Linguagem</th>
    <th>Cliente</th>
    <th colspan="5">Feature-Clients (incluídos no cliente Tealbase)</th>
  </tr>
...
- [Inglês](https://github.com/tealbase/tealbase)
...
[![Novo Patrocinador](https://user-images.githubusercontent.com/10214025/90518111-e74bbb00-e198-11ea-8f88-c9e3c1aa4b5b.png)](https://github.com/sponsors/tealbase)
