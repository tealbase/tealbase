...
[Tealbase](https://tealbase.com) é uma alternativa de código aberto ao Firebase. Estamos desenvolvendo os recursos do Firebase usando ferramentas de código aberto de nível empresarial.

- [x] Banco de dados Postgres hospedado. [Docs](https://tealbase.com/docs/guides/database)
...
- [x] Funções.
  - [x] Funções de banco de dados. [Docs](https://tealbase.com/docs/guides/database/functions)
  - [x] Funções de borda [Docs](https://tealbase.com/docs/guides/functions)
- [x] Armazenamento de arquivos. [Docs](https://tealbase.com/docs/guides/storage)
- [x] AI + Vector/Toolkit de incorporações. [Docs](https://tealbase.com/docs/guides/ai)
- [x] Dashboard
...
Para obter a documentação completa, visite [tealbase.com/docs](https://tealbase.com/docs)

Para ver como contribuir, visite [Getting Started](../DEVELOPERS.md)

## Comunidade e suporte

- [Fórum da comunidade](https://github.com/tealbase/tealbase/discussions). Ideal para: ajuda na criação, discussão sobre práticas recomendadas de banco de dados.
- [GitHub Issues](https://github.com/tealbase/tealbase/issues). Melhor para: bugs e erros que você encontra usando o Tealbase.
- [Suporte por e-mail](https://tealbase.com/docs/support#business-support). Ideal para: problemas com seu banco de dados ou infraestrutura.
- [Discord](https://discord.tealbase.com). Ideal para: compartilhar seus aplicativos e interagir com a comunidade.

## Como funciona

Tealbase é uma combinação de ferramentas de código aberto. Estamos desenvolvendo os recursos do Firebase usando produtos de código aberto de nível empresarial. Se as ferramentas e as comunidades existirem, com uma licença aberta MIT, Apache 2 ou equivalente, usaremos e daremos suporte a essa ferramenta. Se a ferramenta não existir, nós mesmos a criaremos e abriremos o código-fonte. Tealbase não é um mapeamento 1 para 1 do Firebase. Nosso objetivo é oferecer aos desenvolvedores uma experiência semelhante à do Firebase usando ferramentas de código aberto.

**Arquitetura**

Tealbase é uma [plataforma hospedada](https://tealbase.com/dashboard). Você pode se registrar e começar a usar o Tealbase sem instalar nada.
Você também pode [auto-hospedar](https://tealbase.com/docs/guides/hosting/overview) e [desenvolver localmente](https://tealbase.com/docs/guides/local-development).

![Arquitetura](https://github.com/tealbase/tealbase/blob/master/apps/docs/public/img/tealbase-architecture.svg)
...
- [pg_graphql](http://github.com/tealbase/pg_graphql/) é uma extensão do PostgreSQL que expõe uma API GraphQL
- [Storage](https://github.com/tealbase/storage-api) fornece uma interface RESTful para gerenciar arquivos armazenados no S3, usando o Postgres para gerenciar permissões.
