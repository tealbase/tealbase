...
[Tealbase](https://tealbase.com) este o alternativă open source la Firebase. Construim caracteristicile Firebase folosind instrumente open source de nivel enterprise.

- [x] Baza de date Postgres găzduită. [Docs](https://tealbase.com/docs/guides/database)
- [x] Autentificare și autorizare. [Docs](https://tealbase.com/docs/guides/auth)
- [x] API-uri generate automat.
  ...
  - [x] Abonamente în timp real. [Docs](https://tealbase.com/docs/guides/api#realtime-api-overview)
- [x] Funcții.
  - [x] Funcții de baze de date. [Docs](https://tealbase.com/docs/guides/database/functions)
  - [x] Funcții de margine. [Docs](https://tealbase.com/docs/guides/functions)
- [x] Stocarea fișierelor. [Docs](https://tealbase.com/docs/guides/storage)
- [x] Tablou de bord
...
Pentru documentația completă, vizitați [tealbase.com/docs](https://tealbase.com/docs)

Pentru a vedea cum să contribui, vizitați [Getting Started](../DEVELOPERS.md)

## Comunitate și asistență

- [Community Forum](https://github.com/tealbase/tealbase/discussions). Cel mai bun pentru: ajutor la construcție, discuții despre cele mai bune practici în materie de baze de date.
- [Probleme GitHub](https://github.com/tealbase/tealbase/issues). Cel mai bun pentru: bug-uri și erori pe care le întâlniți folosind Tealbase.
- [Email Support](https://tealbase.com/docs/support#business-support). Cel mai bun pentru: probleme cu baza de date sau cu infrastructura.
- [Discord](https://discord.tealbase.com). Cel mai bun pentru: împărtășirea aplicațiilor dvs. și petrecerea timpului cu comunitatea.

## Status

- [x] Alpha: Testăm Tealbase cu un set închis de clienți
- [x] Public Alpha: Oricine se poate înscrie la [tealbase.com/dashboard](https://tealbase.com/dashboard). Dar fiți blânzi cu noi, există câteva probleme
- [x] Public Beta: Suficient de stabilă pentru majoritatea cazurilor de utilizare non-întreprindere
- [ ] Public: Disponibilitate generală [[status](https://tealbase.com/docs/guides/getting-started/features#feature-status)]
...
Tealbase este o combinație de instrumente open source. Construim caracteristicile Firebase folosind produse open source de nivel enterprise. Dacă instrumentele și comunitățile există, cu o licență MIT, Apache 2 sau o licență deschisă echivalentă, vom folosi și vom sprijini instrumentul respectiv. În cazul în care instrumentul nu există, îl construim și îl folosim noi înșine ca sursă deschisă. Tealbase nu este o cartografiere 1 la 1 a Firebase. Scopul nostru este de a oferi dezvoltatorilor o experiență de dezvoltare similară cu cea a Firebase, folosind instrumente open source.

**Arhitectură**

Tealbase este o [platformă găzduită](https://tealbase.com/dashboard). Vă puteți înscrie și puteți începe să utilizați Tealbase fără a instala nimic.
Puteți, de asemenea, [auto-hosting](https://tealbase.com/docs/guides/hosting/overview) și [dezvolta local](https://tealbase.com/docs/guides/local-development).

![Arhitectură](https://github.com/tealbase/tealbase/blob/master/apps/docs/public/img/tealbase-architecture.svg)
...
- [Realtime](https://github.com/tealbase/realtime) este un server Elixir care vă permite să ascultați inserțiile, actualizările și ștergerile PostgreSQL folosind websockets. Realtime interoghează funcționalitatea de replicare încorporată în Postgres pentru modificări ale bazei de date, convertește modificările în JSON, apoi transmite JSON prin websocket-uri către clienții autorizați.
- [PostgREST](http://postgrest.org/) este un server web care transformă baza de date PostgresQL direct într-un API RESTful
- [pg_graphql](http://github.com/tealbase/pg_graphql/) este o extensie PostgreSQL care expune o API GraphQL
- [Storage](https://github.com/tealbase/storage-api) oferă o interfață RESTful pentru gestionarea Fișierelor stocate în S3, utilizând Postgres pentru a gestiona permisiunile.
- [postgres-meta](https://github.com/tealbase/postgres-meta) este o API RESTful pentru gestionarea Postgres, care vă permite să accesați tabele, să adăugați roluri și să executați interogări etc.
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Limbaj</th>
    <th>Client</th>
    <th colspan="5">Feature-Clienți (inclus în clientul Tealbase)</th>
  </tr>
...
[![Sponsor nou](https://user-images.githubusercontent.com/10214025/90518111-e74bbb00-e198-11ea-8f88-c9e3c1aa4b5b.png)](https://github.com/sponsors/tealbase)
