...
[Tealbase](https://tealbase.com) je open source alternatíva Firebase. Funkcie Firebase budujeme pomocou open source nástrojov podnikovej triedy.

- [x] hostovaná databáza Postgres. [Dokumenty](https://tealbase.com/docs/guides/database)
- [x] Autentifikácia a autorizácia. [Dokumenty](https://tealbase.com/docs/guides/auth)
- [x] Automaticky generované rozhrania API.
  ...
  - [x] Odbery v reálnom čase. [Docs](https://tealbase.com/docs/guides/api#realtime-api-overview)
- [x] Funkcie.
  - [x] Databázové funkcie. [Docs](https://tealbase.com/docs/guides/database/functions)
  - [x] Okrajové funkcie [Docs](https://tealbase.com/docs/guides/functions)
- [x] Ukladanie súborov. [Dokumenty](https://tealbase.com/docs/guides/storage)
- [x] Prístrojový panel
...
Úplnú dokumentáciu nájdete na stránke [tealbase.com/docs](https://tealbase.com/docs)

Ak chcete zistiť, ako prispievať, navštívte stránku [Začíname](../DEVELOPERS.md)

## Komunita a podpora

- [Fórum komunity](https://github.com/tealbase/tealbase/discussions). Najlepšie pre: pomoc pri vytváraní, diskusie o osvedčených postupoch pri práci s databázou.
- [GitHub Issues](https://github.com/tealbase/tealbase/issues). Najlepšie pre: chyby a omyly, na ktoré narazíte pri používaní databázy Tealbase.
- [E-mailová podpora](https://tealbase.com/docs/support#business-support). Najlepšie pre: problémy s vašou databázou alebo infraštruktúrou.
- [Discord](https://discord.tealbase.com). Najlepšie na: zdieľanie vašich aplikácií a stretávanie sa s komunitou.

## Stav

- [x] Alfa: Testujeme Tealbase s uzavretým súborom zákazníkov
- [x] Verejná alfa: [tealbase.com/dashboard](https://tealbase.com/dashboard). Ale buďte na nás mierni, je tu niekoľko zádrheľov
- [x] Verejná beta verzia: Dostatočne stabilná pre väčšinu prípadov použitia, ktoré nie sú určené pre podniky
- [ ] Verejná: Všeobecná dostupnosť [[status](https://tealbase.com/docs/guides/getting-started/features#feature-status)]
...
Tealbase je kombináciou nástrojov s otvoreným zdrojovým kódom. Funkcie Firebase budujeme pomocou produktov s otvoreným zdrojovým kódom podnikovej úrovne. Ak existujú nástroje a komunity s otvorenou licenciou MIT, Apache 2 alebo ekvivalentnou otvorenou licenciou, budeme tento nástroj používať a podporovať. Ak nástroj neexistuje, vytvoríme ho a použijeme open source sami. Databáza Tealbase nie je mapovaním databázy Firebase v pomere 1:1. Naším cieľom je poskytnúť vývojárom vývojársky zážitok podobný Firebase pomocou nástrojov s otvoreným zdrojovým kódom.

**Architektúra**

Tealbase je [hostovaná platforma](https://tealbase.com/dashboard). Môžete sa zaregistrovať a začať používať Tealbase bez toho, aby ste čokoľvek inštalovali.
Môžete tiež [samostatne hosťovať](https://tealbase.com/docs/guides/hosting/overview) a [vyvíjať lokálne](https://tealbase.com/docs/guides/local-development).
...
- [Realtime](https://github.com/tealbase/realtime) je server Elixir, ktorý umožňuje počúvať vkladanie, aktualizáciu a mazanie údajov PostgreSQL pomocou webových soketov. Realtime vyhľadáva zmeny v databáze pomocou zabudovanej replikačnej funkcie Postgresu, konvertuje zmeny na JSON a potom vysiela JSON cez websockety autorizovaným klientom.
- [PostgREST](http://postgrest.org/) je webový server, ktorý zmení vašu databázu PostgreSQL priamo na RESTful API
- [pg_graphql](http://github.com/tealbase/pg_graphql/) je rozšírenie PostgreSQL, ktoré vystavuje GraphQL API
- [Storage](https://github.com/tealbase/storage-api) poskytuje RESTful rozhranie na správu súborov uložených v S3, pričom na správu oprávnení používa Postgres.
- [postgres-meta](https://github.com/tealbase/postgres-meta) je RESTful API na správu Postgresu, ktoré umožňuje načítavať tabuľky, pridávať roly a spúšťať dotazy atď.
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Jazyk</th>
    <th>Klient</th>
    <th colspan="5">Feature-Clients (v balíku s klientom Tealbase)</th>
  </tr>
