...
[Tealbase](https://tealbase.com) 是一个开源的 Firebase 替代品。我们正在使用企业级的开源工具构建 Firebase 的功能。

- [x] Postgres 数据库托管。[文档](https://tealbase.com/docs/guides/database)
- [x] 身份验证和授权。[文档](https://tealbase.com/docs/guides/auth)
- [x] 自动生成的 API。
  - [x] REST。[文档](https://tealbase.com/docs/guides/api)
  - [x] GraphQL。[文档](https://tealbase.com/docs/guides/graphql)
  - [x] 实时订阅。[文档](https://tealbase.com/docs/guides/realtime)
- [x] 函数。
  - [x] 数据库函数。[文档](https://tealbase.com/docs/guides/database/functions)
  - [x] 边缘函数。[文档](https://tealbase.com/docs/guides/functions)
- [x] 文件存储。[文档](https://tealbase.com/docs/guides/storage)
- [x] AI + 向量/Embeddings 工具包. [Docs](https://tealbase.com/docs/guides/ai)
- [x] 仪表盘。
...
<kbd><img src="https://raw.githubusercontent.com/tealbase/tealbase/d5f7f413ab356dc1a92075cb3cee4e40a957d5b1/web/static/watch-repo.gif" alt="关注此仓库"/></kbd>

## 文档

完整的文档，请访问 [tealbase.com/docs](https://tealbase.com/docs)

了解如何贡献，请访问[入门](../DEVELOPERS.md)

## 社区与支持

- [社区论坛](https://github.com/tealbase/tealbase/discussions)。适用于：帮助建立和讨论数据库的最佳实践。
- [GitHub Issues](https://github.com/tealbase/tealbase/issues)。适用于：你在使用 Tealbase 时遇到的 bug 和错误。
- [邮件支持](https://tealbase.com/docs/support#business-support)。适用于：你的数据库或基础设施的问题。
- [Discord](https://discord.tealbase.com)。适用于：分享你的应用程序以及在社区一起玩起来。

## 工作方式

Tealbase 是一个开源工具的组合。我们正在使用企业级的开源产品构建 Firebase 的功能。如果存在相应的工具和社区，并且有 MIT、Apache 2 或同等的开放许可，我们将使用并支持该工具。如果该工具不存在，我们就自己开发并开放源代码。Tealbase 不是 Firebase 的一对一映射。我们的目标是使用开源工具为开发者提供类似 Firebase 的开发者体验。

**当前架构**

Tealbase 是一个[托管平台](https://tealbase.com/dashboard)。你可以注册并开始使用 Tealbase，而无需安装任何软件。
你也可以[自托管](https://tealbase.com/docs/guides/hosting/overview)和[本地开发](https://tealbase.com/docs/guides/local-development)。

![架构](https://github.com/tealbase/tealbase/blob/master/apps/docs/public/img/tealbase-architecture.svg)

- [PostgreSQL](https://www.postgresql.org/) 是一个对象关系型数据库系统，经过 30 多年的积极开发，它在可靠性、功能健壮性和性能方面赢得了很好的声誉。
- [Realtime](https://github.com/tealbase/realtime) 是一个 Elixir 服务器，允许你使用 WebSocket 监听 PostgreSQL 的插入、更新和删除。Tealbase 监听 Postgres 的内置复制功能，将复制的字节流转换为 JSON，然后通过 WebSocket 广播 JSON。
- [PostgREST](http://postgrest.org/) 是一个 Web 服务器，可以将你的 PostgreSQL 数据库直接生成 RESTful API
- [GoTrue](https://github.com/tealbase/gotrue) 是一个基于 SWT 的 API，用于管理用户和发布 SWT 令牌。
- [Storage](https://github.com/tealbase/storage-api) 提供了一个 RESTful 接口，用于管理存储在 S3 中的文件，使用 Postgres 来管理权限。
- [pg_graphql](http://github.com/tealbase/pg_graphql/) 公开GraphQL API的PostgreSQL扩展
- [postgres-meta](https://github.com/tealbase/postgres-meta) 是一个 RESTful API，用于管理你的 Postgres，允许你获取表、添加角色和运行查询等。
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>语言</th>
    <th>客户端</th>
    <th colspan="5">模块-客户端（已集成在 Tealbase 客户端中）</th>
  </tr>
  <!-- notranslate -->
  <tr>
    <th></th>
...
[![加入赞助](https://user-images.githubusercontent.com/10214025/90518111-e74bbb00-e198-11ea-8f88-c9e3c1aa4b5b.png)](https://github.com/sponsors/tealbase)
